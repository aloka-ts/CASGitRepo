...
@LocalBinding (jndiBinding="maps/LocalMgmtSessionFacade")
@SecurityDomain("portal")
public class MgmtSessionFacade extends AbstractSessionFacade implements ICPFSessionFacade {

	//Inject EJB
	//@EJB (beanName="EntityManagerWrapper")
	@EJB (mappedName="maps/LocalMgmtEntityManagerWrapper")
	private IEntityManagerWrapper m_handler;
	
	private static final Logger LOG = Logger.getLogger(MgmtSessionFacade.class);
