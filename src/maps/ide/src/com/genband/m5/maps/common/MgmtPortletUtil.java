...
public class MgmtPortletUtil {
	private static final Logger LOG = Logger.getLogger(MgmtPortletUtil.class);
	...
	public List<SelectItem> getData(String baseEntityName, String primaryKeyName
		...
		//MgmtManager cpfManager = new MgmtManager();
		Collection<Object[]> result = MgmtManager.getResult(criteria);
