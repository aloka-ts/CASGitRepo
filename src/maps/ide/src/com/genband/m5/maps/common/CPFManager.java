...
public class CPFManager {
	...
	static{
		try {
			...
			Object o = ctx.lookup("maps/LocalCPFSessionFacade");
...
//TODO ServiceLocator for CPFSessionFacade
	...
	public static String save(Object rootEntity, int opId) throws CPFException{
	...
	public static String save(Object rootEntity, Criteria c, int opId) throws CPFException{
	...
	public static String delete (Object rootEntity, Long primaryKeyValue, int opId) throws CPFException {
