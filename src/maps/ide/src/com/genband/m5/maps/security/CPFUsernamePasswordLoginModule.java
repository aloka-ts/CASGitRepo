 ...
 */
public abstract class CPFUsernamePasswordLoginModule extends AbstractServerLoginModule
{
	private static final Logger log = Logger.getLogger (CPFUsernamePasswordLoginModule.class);
   ...
   */
      ...
      Map sharedState, Map options)
   {
      ...
      if( hashAlgorithm != null )
      {
         ...
         {
            log.debug ("Password hashing activated: algorithm = " + hashAlgorithm
   ...
   public boolean login() throws LoginException
   {
      ...
      if( super.login() == true )
      {
         ...
         else
         {
            ...
            try
            {
            	log.debug ("calling createIdentity in login for shared id");
      ...
      if( identity == null )
      {
         ...
         log.debug("syed: exp pswd: " + expectedPassword);
         ...
         try
         {
            identity = createIdentity(username, true); //reset it with organization a/c
         }
         catch(Exception e)
         {
            log.debug("Failed to create principal", e);
   ...
   */
     ...
     throws LoginException
   {
      ...
      if( callbackClassName != null )
      {
         try
         {
            ...
            if( log.isDebugEnabled() )
               log.debug("Created DigestCallback: "+callback);
         }
         catch (Exception e)
         {
            if( log.isDebugEnabled() )
               log.debug("Failed to load DigestCallback", e);
   ...
   protected abstract Principal createIdentity(String username, boolean hasOrganization) throws Exception;
   
   abstract protected Organization getPrincipalOrganization (Principal identity);
}
