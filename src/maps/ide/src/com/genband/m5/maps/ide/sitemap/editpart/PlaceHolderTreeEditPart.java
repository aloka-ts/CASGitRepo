...
*
*     File:     PlaceHolderTreeEditPart.java
*
...
/**
 * TreeEditPart used for PlaceHolder instances.
 ...
 * @author Genband
 */
class PlaceHolderTreeEditPart extends AbstractTreeEditPart implements
		PropertyChangeListener {

/**
 * Create a new instance of this edit part using the given model element.
 * @param model a non-null PlaceHolder instance
 */
PlaceHolderTreeEditPart(PlaceHolder model) {
	super(model);
}
