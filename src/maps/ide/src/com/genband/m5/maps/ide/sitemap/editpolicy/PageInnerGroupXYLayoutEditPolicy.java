...
*
*     File:     PageInnerGroupXYLayoutEditPolicy.java
*
*     Desc:   	This is the edit policy for pageChildGroup and pageContentGroup.
*     					It actually disallows page etc.(each component) to
*     					be added to pageChildGroup and pageContentGroup.
*
...
public class PageInnerGroupXYLayoutEditPolicy extends XYLayoutEditPolicy {
	...
	/*	if (child instanceof PageInnerGroupEditPart && constraint instanceof Rectangle) {
	...
	*/
	...
	protected Command getCreateCommand(CreateRequest request) {
		System.out.println("PageInnerGroupXYLayoutEditPolicy: getCreateCommand entered");
