...
public static final String LINE_DELIMITER = "\n";
	...
	private static final String MESSAGE_HANDLER_IF = "com.baypackets.ase.resource.MessageHandler".intern();
	private static final String SERVLET_CONTEXT = "javax.servlet.ServletContext".intern();
	private static final String MESSAGE = "com.baypackets.ase.resource.Message".intern();
	...
	private static final String[] INIT_PARAM_NAMES = new String[] {"context".intern()};

	private static final String[] HANDLE_MESSAGE_PARAM_TYPES = new String[] {MESSAGE};
	private static final String[] HANDLE_MESSAGE_NAMES = new String[] {"message".intern()};
...
//		if(this.bInit){
			super.createMethod(type, imports, monitor, "init", INIT_PARAM_TYPES, INIT_PARAM_NAMES, NULL_PARAMS, VOID_TYPE, null);
//		}
//		if(this.bDestroy){
			super.createMethod(type, imports, monitor, "handleMessage", HANDLE_MESSAGE_PARAM_TYPES, HANDLE_MESSAGE_NAMES, new String[]{RESOURCE_EXCEPTION}, VOID_TYPE, null);
//		}
