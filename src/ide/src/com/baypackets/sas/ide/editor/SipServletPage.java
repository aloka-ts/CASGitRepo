...
//	private SipServletSection servletSection;
	...
	private void fillBody(IManagedForm managedForm) {
		...
		if (isSip289Xml) {
			SipServlet289Section servletSection = new SipServlet289Section(this, top);
		...
		if (isSip289Xml) {
			...
			managedForm.addPart(mainServletSection);
			 ...
			 SasPlugin.getDefault().log("MainServlet is defined?? .."+mainServletSection.mainServletDefined);
		}
		...
		servletMappingSection = new SipServletMappingSection(this, bottomLeft,mainServletSection.mainServletDefined);
