...
public class RAMessageHandlerMappingSection extends SectionPart implements ModelListener {
	...
	public RAMessageHandlerMappingSection(BPFormPage page, Composite parent) {
		super(parent, page.getManagedForm().getToolkit(), Section.TITLE_BAR | Section.DESCRIPTION);
		this.page = page;
		
		//Create the UI.
		this.getSection().setText("Message Handlers Mapping");
		this.createControls();
	...
	public void modelChanged(int action, Node data) {
		...
		if(data != null 
			 ...
			 SasPlugin.getDefault().log("RAMessageHandlerMappingSection  modelChanged()  ");
