...
public class SipServlet289Section extends SectionPart implements ModelListener {
	
	private static final String SERVLET = "servlet".intern();
	private static final String SERVLET_CLASS = "javaee:servlet-class".intern();
	private static final String SERVLET_NAME = "javaee:servlet-name".intern();
	private static final String DISPLAY_NAME = "javaee:display-name".intern();
	private static final String DESCRIPTION = "javaee:description".intern();
	private static final String LOAD_ON_STARTUP = "javaee:load-on-startup".intern();
	
	private BPFormPage page;
	
	public SipServlet289Section(BPFormPage page, Composite parent) {
	...
	public void init(){
		//Create the UI.
		this.getSection().setText("SIP Servlets");
		this.createControls();
...
//				System.out.println("SelectionChanged() of SipServletSection is called ................");
				...
				if(page instanceof SipServletPage){
					((SipServletPage)page).selectionChanged(selection);
				}
			}
		};
