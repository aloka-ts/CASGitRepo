 ...
 */
public class SASServerLoggerView extends ViewPart {
	...
	private static final String SAS_LOGS_STATE_FILENAME = "sasServerLoggerState.xml";
	private final String SAS_LOG = "CAS.log";
	...
	public void loadWatcherState() {
		...
		path = path.append(SAS_LOGS_STATE_FILENAME);

		if (!path.toFile().exists()) {
			SasPlugin
					.getDefault()
					.log(
							"SASServerLoggerView: sasServerLoggerState.xml file donot exist so calling addWatcher()........................");
			if(watcher!=null){
	...
	public void addWatcher(int interval, int numLines, Vector filters,
		...
		SasPlugin.getDefault().log(
				"SASServerLoggerView: addWatcher() with interval "+ interval +" numLines "+numLines+ "Filters "+filters);
		...
		if (viewer == null) {
			...
			menuMgr.addMenuListener(new IMenuListener() {
				public void menuAboutToShow(IMenuManager manager) {
					SASServerLoggerView.this.fillContextMenu(manager);
				}
			});
		...
		try {
			...
			watcher = new LogFilesListener(interval, numLines, this.SAS_LOG);
