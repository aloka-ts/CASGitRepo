...
public class BPProjectINFO 
{
	...
	public boolean initialize(String projectName) 
	{
		try
		{
			...
			SasPlugin.getDefault().log("Application Nanme === >"+applicationName);
			SasPlugin.getDefault().log("Application ersion === >"+applicationVersion);
			SasPlugin.getDefault().log("ApplicationPriority === >"+applicationPriority);
