...
public class ConvergedHttpSessionImpl extends DeltaSession  
			implements ConvergedHttpSession, SasProtocolSession {

	private static Logger logger = Logger.getLogger(ConvergedHttpSessionImpl.class);
	...
	public ConvergedHttpSessionImpl() {
		super(null);
	}
	
	public ConvergedHttpSessionImpl(Manager manager) {
		super(manager);
	}
