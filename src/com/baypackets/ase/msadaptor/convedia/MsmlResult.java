...
public class MsmlResult extends DefaultHandler implements MsOperationResult, Serializable {
	private static final long serialVersionUID = 399872821748019L;
	...
	public void startElement(String uri, String localName, String qName,
		...
		if (qName != null && qName.equals(ELEMENT_EVENT)) {
			...
			if (eventName != null && eventName.equals(VALUE_DLG_EXIT)) {
				isDialogExitEvent = true;
			}
	...
	private void processResult() {
		...
		if (lastDigit != null && DTMF_TERM_LIST.contains(lastDigit) && digits != null) {
				if(digits.endsWith(termKey) || digits.endsWith(lastDigit)) {
					digits = digits.substring(0, digits.length() - lastDigit.length());
