...
@XmlRootElement(name="Created-PCC")
public class CreatePCCResponse {
	@XmlElement(name ="PCC")
	private List<PersonalContactCard> pccList;
	@XmlElement(name = "Error-List")
	private Errors errors;
	
	public CreatePCCResponse(){}
	
	/**
	 * @param pccList
	 * @param errors
	 */
	public CreatePCCResponse(List<PersonalContactCard> pccList, Errors errors) {
		super();
