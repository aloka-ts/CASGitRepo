...
@XmlRootElement(name="Added-To-Address-Book-Groups")
public class AddToAddressBookGroupsResponse {
	...
	public AddToAddressBookGroupsResponse(){}
	/**
	 * @param groupList
	 * @param errors
	 */
	public AddToAddressBookGroupsResponse(List<AddressBookGroup> groupList,
			Errors errors) {
