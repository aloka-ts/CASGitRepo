...
@XmlRootElement(name="Deleted-Address-Book-Groups")
public class DeleteAddressBookGroupsResponse {
	...
	public DeleteAddressBookGroupsResponse(){}
	/**
	 * @param groupList
	 * @param errors
	 */
	public DeleteAddressBookGroupsResponse(List<AddressBookGroup> groupList,
			Errors errors) {
