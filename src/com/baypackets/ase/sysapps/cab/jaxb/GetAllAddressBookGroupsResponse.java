...
@XmlRootElement(name="Get-All-Address-Book-Groups")
public class GetAllAddressBookGroupsResponse {
	...
	public GetAllAddressBookGroupsResponse(){}
	/**
	 * @param groupList
	 * @param errors
	 */
	public GetAllAddressBookGroupsResponse(List<AddressBookGroup> groupList,
			Errors errors) {
