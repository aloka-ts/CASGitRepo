...
@XmlRootElement(name="Removed-From-Address-Book-Groups")
public class RemoveFromAddressBookGroupsResponse {
	...
	public RemoveFromAddressBookGroupsResponse(){}
	/**
	 * @param groupList
	 * @param errors
	 */
	public RemoveFromAddressBookGroupsResponse(List<AddressBookGroup> groupList,
			Errors errors) {
