...
@XmlRootElement(name="Associated-Contact-Views")
public class AssociateContactViewsResponse {
	...
	public AssociateContactViewsResponse(){}
	/**
	 * @param groupList
	 * @param errors
	 */
	public AssociateContactViewsResponse(List<AddressBookGroup> groupList,
			Errors errors) {
