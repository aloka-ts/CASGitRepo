...
@XmlRootElement(name="Modified-Contact-Views")
public class ModifyContactViewsResponse {
	...
	public ModifyContactViewsResponse(){}	

	/**
	 * @param contactViewList
	 * @param errors
	 */
	public ModifyContactViewsResponse(List<ContactView> contactViewList,
			Errors errors) {
