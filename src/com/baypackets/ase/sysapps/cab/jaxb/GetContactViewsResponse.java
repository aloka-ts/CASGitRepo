...
@XmlRootElement(name="Get-Contact-Views")
public class GetContactViewsResponse {
	...
	public GetContactViewsResponse(){}	

	/**
	 * @param contactViewList
	 * @param errors
	 */
	public GetContactViewsResponse(List<ContactView> contactViewList,
			Errors errors) {
