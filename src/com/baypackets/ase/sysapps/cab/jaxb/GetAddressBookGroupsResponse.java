...
@XmlRootElement(name="Get-Address-Book-Groups")
public class GetAddressBookGroupsResponse {
	...
	public GetAddressBookGroupsResponse(){}
	/**
	 * @param groupList
	 * @param errors
	 */
	public GetAddressBookGroupsResponse(List<AddressBookGroup> groupList,
			Errors errors) {
