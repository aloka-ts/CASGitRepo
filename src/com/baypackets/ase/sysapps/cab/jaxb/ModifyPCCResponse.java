...
@XmlRootElement(name="Modified-PCC")
public class ModifyPCCResponse {
	@XmlElement(name ="PCC")
	private List<PersonalContactCard> pccList;
	@XmlElement(name = "Error-List")
	private Errors errors;
	
	public ModifyPCCResponse(){}
	
	/**
	 * @param pccList
	 * @param errors
	 */
	public ModifyPCCResponse(List<PersonalContactCard> pccList, Errors errors) {
		super();
