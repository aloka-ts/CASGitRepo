...
@XmlRootElement(name="Assign-User-Channels")
public class AssignUserChannelsRequest {
	...
	public AssignUserChannelsRequest(){}
	
	public AssignUserChannelsRequest(String applicationId,String aconyxUsername,List<Channel> channels){
		super();
