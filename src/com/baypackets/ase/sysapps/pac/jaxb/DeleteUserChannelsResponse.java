...
@XmlRootElement(name="Deleted-User-Channels")
public class DeleteUserChannelsResponse {
	...
	public  DeleteUserChannelsResponse() {}
	public DeleteUserChannelsResponse(String applicationId,
