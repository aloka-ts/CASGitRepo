...
public class GetAconyxUsernameRequest {
	...
	public GetAconyxUsernameRequest() {
		
	}
	
	public GetAconyxUsernameRequest(String applicationId, List<UserChannel> userChannels) {
		super();
