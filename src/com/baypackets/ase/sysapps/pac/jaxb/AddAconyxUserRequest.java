...
@XmlRootElement(name="Add-Aconyx-User")
public class AddAconyxUserRequest {
	...
	public AddAconyxUserRequest(){}
	
	public AddAconyxUserRequest(String aconyxUsername, String password,
