...
@XmlRootElement(name="Modified-User-Channels")
public class ModifyUserChannelsResponse {
	...
	public ModifyUserChannelsResponse(){}
	public ModifyUserChannelsResponse(String applicationId,
