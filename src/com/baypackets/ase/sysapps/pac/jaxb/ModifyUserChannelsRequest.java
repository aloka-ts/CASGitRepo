...
@XmlRootElement(name="Modify-User-Channels")
public class ModifyUserChannelsRequest {
	...
	public ModifyUserChannelsRequest(){}
	
	public ModifyUserChannelsRequest(String applicationId,
