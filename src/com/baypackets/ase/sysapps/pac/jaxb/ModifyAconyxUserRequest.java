...
@XmlRootElement(name="Modify-Aconyx-User")
public class ModifyAconyxUserRequest {
	...
	public ModifyAconyxUserRequest(){}
	
	public ModifyAconyxUserRequest(String aconyxUsername, String password,
			String encrypted, String role) {
		super();
