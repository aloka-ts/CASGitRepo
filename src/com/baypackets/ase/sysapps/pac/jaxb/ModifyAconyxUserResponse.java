...
@XmlRootElement(name="Modified-Aconyx-User")
public class ModifyAconyxUserResponse {
	...
	public ModifyAconyxUserResponse(){}
	
	public ModifyAconyxUserResponse(String aconyxUsername, String role, Errors errors) {
		super();
