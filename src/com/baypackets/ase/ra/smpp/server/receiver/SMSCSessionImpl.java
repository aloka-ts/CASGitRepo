...
public class SMSCSessionImpl extends SmppObject implements SMSCSession {
	private static Logger logger = Logger.getLogger(SMSCSessionImpl.class);
	...
	public void run() {
		...
		try {
			while (keepReceiving) {
				...
				logger.debug("SMSCSession going to receive a PDU");
					...
					logger.error("SMSCSession caught exception receiving PDU " + e.getMessage());
				}
		...
		try {
			...
			logger.error("closing SMSCSession's connection due to " +e);
