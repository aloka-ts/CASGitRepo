...
public class EnquireLink extends AbstractSmppRequest {

	private static Logger logger = Logger.getLogger(EnquireLink.class);
	/**
	...
	*/
	 ...
	 *
	 */
	private org.smpp.pdu.EnquireLink stackObj;
	private SmppSession m_session;


	public EnquireLink() {
		if(logger.isDebugEnabled()) {
			logger.debug("Inside EnquireLink()");
		}
		stackObj = new org.smpp.pdu.EnquireLink();
	}

	public EnquireLink(SmppSession session) {
		if(logger.isDebugEnabled()) {
			logger.debug("Inside EnquireLink(SmppSession)");
		}
		stackObj = new org.smpp.pdu.EnquireLink();
		this.m_session=session;
	}

	public EnquireLink(org.smpp.pdu.EnquireLink stackObj){
		if(logger.isDebugEnabled()) {
			logger.debug("Inside EnquireLink(org.smpp.pdu.EnquireLink)");
		}
	...
	public org.smpp.pdu.EnquireLink getStackObject(){
		if(logger.isDebugEnabled()) {
	...
	public SmppResponse createResponse(){
		...
		org.smpp.pdu.EnquireLinkResp response = new org.smpp.pdu.EnquireLinkResp();
