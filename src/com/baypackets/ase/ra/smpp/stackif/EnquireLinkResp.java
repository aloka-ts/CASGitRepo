...
public class EnquireLinkResp extends AbstractSmppResponse {

	private static Logger logger = Logger.getLogger(EnquireLinkResp.class);
	/**
	...
	*
	*/
	private org.smpp.pdu.EnquireLinkResp stackObj;

	public EnquireLinkResp(){
		if(logger.isDebugEnabled()) {
			logger.debug("Inside EnquireLinkResp()");
		}
		stackObj = new org.smpp.pdu.EnquireLinkResp();
	}

	public EnquireLinkResp(org.smpp.pdu.EnquireLinkResp stackObj){
		if(logger.isDebugEnabled()) {
			logger.debug("Inside EnquireLinkResp(org.smpp.pdu.EnquireLinkResp)");
		}
	...
	public org.smpp.pdu.EnquireLinkResp getStackObj(){
		if(logger.isDebugEnabled()) {
