...
/***********************************************************************************
//
//      File:   CancelSMResp.java
//
//		Desc:	SMSC sends this response in response to the CancelSM request sent 
//				earlier by application to SMSC. Basically this response class is
//				a wrapper on underlying stack's org.smpp.pdu.CancelResp class. 
...
//				All of the application set/get operations are executed on this 
//				class object are intern are executed on underlying stack class object.
//	
...
public class CancelSMResp extends AbstractSmppResponse {
	
	private static Logger logger = Logger.getLogger(CancelSMResp.class);
	...
	*
	*/
	private org.smpp.pdu.CancelSMResp stackObj;

	public CancelSMResp(org.smpp.pdu.CancelSMResp stkObj) {
		if(logger.isDebugEnabled()) {
			logger.debug("Inside CancelSMResp()");
		}
		setType(Constants.CANCEL_SM_RES);
		stackObj = stkObj;
	}
	...
	public org.smpp.pdu.CancelSMResp getStackObj(){
		if(logger.isDebugEnabled()) {
