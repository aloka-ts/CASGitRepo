...
public class GenericNack extends AbstractSmppRequest {

	private static Logger logger = Logger.getLogger(GenericNack.class);
	/**
	...
	*/
	 ...
	 *
	 */
	private org.smpp.pdu.GenericNack stackObj;
	private SmppSession m_session;


	public GenericNack(){
		if(logger.isDebugEnabled()) {
			logger.debug("Inside GenericNack()");
		}
		stackObj = new org.smpp.pdu.GenericNack();
	}
	...
	*/
	...
	public GenericNack(org.smpp.pdu.GenericNack stackObj) {
		if(logger.isDebugEnabled()) {
			logger.debug("Inside GenericNack(org.smpp.pdu.GenericNack)");
		}
	...
	public org.smpp.pdu.GenericNack getStackObject(){
		if(logger.isDebugEnabled()) {
