...
public interface RadiusRequest extends Request{
	...
	/**
	 * This method returns the remoteAddess from which request received
	 * @return the remoteAddess from which request received
	 */
	public InetSocketAddress getRemoteAddress() ;
	
	/**
	 * This method returns the DatagramSocket on which request received
