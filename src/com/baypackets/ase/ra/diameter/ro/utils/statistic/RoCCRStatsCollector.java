...
/**
 * 
 * This class will be used for holding RO CCR processing related statistics.
 * @author Amit Baxi
 *
 */
public class RoCCRStatsCollector {

	private static RoCCRStatsCollector collector=new RoCCRStatsCollector();
	private static int MAX_SIZE=100;
	private static LinkedList<HashMap <Integer,ArrayList<Long>>> statsList=new LinkedList<HashMap <Integer,ArrayList<Long>>>();
	private RoCCRStatsCollector(){

	}

	public static RoCCRStatsCollector getInstance(){
		return collector;
	}
	...
	public void printStats(PrintStream out){
		out.println("<------------ RO CCR STATS START --------------->");
