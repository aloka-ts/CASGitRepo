...
//import com.traffix.openblox.diameter.coding.DiameterMessage;
...
public abstract class RoAbstractResponse extends RoMessage implements RoResponse {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static Logger logger = Logger.getLogger(RoAbstractResponse.class);
	...
	public RoAbstractResponse(int type) {
		super(type);
	}

	public RoAbstractResponse(RoSession session){
		super();
		this.m_session=session;
	}

	public RoAbstractResponse(DiameterMessage stkObj){
		super();
	...
	public int getWorkQueue() {
		...
		if(stackObj!=null){
			...
			logger.error("NULL stack object for RoResponse so using index:"+index);
		}
		return index;
	}
	...
	public void send() throws IOException {
		...
		if(context != null){
			...
			logger.info("Send to RO resource adaptor directly.");
			try {
