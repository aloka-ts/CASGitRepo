...
import com.traffix.openblox.diameter.gy.generated.avp.AvpUnitQuotaThreshold;

public class UnitQuotaThresholdAvp extends AvpDiameterUnsigned32 {

	private static Logger logger = Logger.getLogger(UnitQuotaThresholdAvp.class.getName());
