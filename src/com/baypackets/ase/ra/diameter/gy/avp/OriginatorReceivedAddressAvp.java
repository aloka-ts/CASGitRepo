...
import com.traffix.openblox.diameter.gy.generated.avp.AvpOriginatorReceivedAddress;
import com.traffix.openblox.diameter.gy.generated.enums.EnumAddressType;

public class OriginatorReceivedAddressAvp extends AvpDiameterGrouped {

	private static Logger logger = Logger.getLogger(OriginatorReceivedAddressAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpOriginatorReceivedAddress stackObj;

	public OriginatorReceivedAddressAvp(AvpOriginatorReceivedAddress stkObj){
		super(stkObj);
