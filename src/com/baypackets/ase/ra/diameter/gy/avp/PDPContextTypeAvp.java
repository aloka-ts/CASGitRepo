...
import com.traffix.openblox.diameter.gy.generated.avp.AvpPDPContextType;

public class PDPContextTypeAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(PDPContextTypeAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpPDPContextType stackObj;

	public PDPContextTypeAvp(AvpPDPContextType stkObj){
		super(stkObj);
