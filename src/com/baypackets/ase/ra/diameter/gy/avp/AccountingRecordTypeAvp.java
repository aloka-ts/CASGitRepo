...
import com.traffix.openblox.diameter.gy.generated.avp.AvpAccountingRecordType;

public class AccountingRecordTypeAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(AccountingRecordTypeAvp.class.getName());
