...
import com.traffix.openblox.diameter.gy.generated.avp.AvpPoCChangeCondition;

public class PoCChangeConditionAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(PoCChangeConditionAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpPoCChangeCondition stackObj;

	public PoCChangeConditionAvp(AvpPoCChangeCondition stkObj){
		super(stkObj);
