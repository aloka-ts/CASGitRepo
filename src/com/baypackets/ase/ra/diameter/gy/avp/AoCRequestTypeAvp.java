...
import com.traffix.openblox.diameter.gy.generated.avp.AvpAoCRequestType;

public class AoCRequestTypeAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(AoCRequestTypeAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpAoCRequestType stackObj;

	public AoCRequestTypeAvp(AvpAoCRequestType stkObj){
		super(stkObj);
