...
import com.traffix.openblox.diameter.gy.generated.avp.AvpAoCServiceType;

public class AoCServiceTypeAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(AoCServiceTypeAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpAoCServiceType stackObj;

	public AoCServiceTypeAvp(AvpAoCServiceType stkObj){
		super(stkObj);
