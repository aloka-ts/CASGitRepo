...
import com.traffix.openblox.diameter.gy.generated.avp.AvpPoCUserRoleInfoUnits;

public class PoCUserRoleInfoUnitsAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(PoCUserRoleInfoUnitsAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpPoCUserRoleInfoUnits stackObj;

	public PoCUserRoleInfoUnitsAvp(AvpPoCUserRoleInfoUnits stkObj){
		super(stkObj);
