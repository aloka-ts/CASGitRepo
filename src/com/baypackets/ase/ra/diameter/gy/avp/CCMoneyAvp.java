...
import com.traffix.openblox.diameter.gy.generated.avp.AvpCCMoney;

public class CCMoneyAvp extends AvpDiameterGrouped {

	private static Logger logger = Logger.getLogger(CCMoneyAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpCCMoney stackObj;

	public CCMoneyAvp(AvpCCMoney stkObj){
		super(stkObj);
