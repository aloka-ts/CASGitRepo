...
import com.traffix.openblox.diameter.gy.generated.avp.AvpPreemptionCapability;

public class PreemptionCapabilityAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(PreemptionCapabilityAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpPreemptionCapability stackObj; 

	public PreemptionCapabilityAvp(AvpPreemptionCapability stkObj){
		super(stkObj);
