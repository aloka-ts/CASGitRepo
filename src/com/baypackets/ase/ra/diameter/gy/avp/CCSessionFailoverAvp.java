...
import com.traffix.openblox.diameter.gy.generated.avp.AvpCCSessionFailover;

public class CCSessionFailoverAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(CCSessionFailoverAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpCCSessionFailover stackObj;

	public CCSessionFailoverAvp(AvpCCSessionFailover stkObj){
		super(stkObj);
