...
import com.traffix.openblox.diameter.gy.generated.avp.AvpEventType;
...
public class EventTypeAvp extends AvpDiameterGrouped {
	...
	*/
	public EventAvp addEvent(java.lang.String value) throws GyResourceException  {
		try {
			...
			throw new GyResourceException("Exception in addEvent ",e);
		}
	}
	...
	*/
	public ExpiresAvp addExpires(long value) throws GyResourceException  {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new GyResourceException("Exception in addExpires ",e);
		}
	}
	...
	*  Adding SIPMethod AVP of type UTF8String to the message.
	 * @throws GyResourceException 
	*/
	public SIPMethodAvp addSIPMethod(java.lang.String value) throws GyResourceException  {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new GyResourceException("Exception in addSIPMethod ",e);
		}
	}
	...
	*  Retrieving a single UTF8String value from Event AVPs.
	 * @throws GyResourceException 
	*/
	public java.lang.String getEvent() throws GyResourceException  {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new GyResourceException("Exception in getEvent ",e);
		}
	}
	...
	*  Retrieving a single Unsigned32 value from Expires AVPs.
	 * @throws GyResourceException 
	*/
	public long getExpires() throws GyResourceException  {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new GyResourceException("Exception in getExpires ",e);
		}
	}
	...
	*  Retrieving a single UTF8String value from SIPMethod AVPs.
	 * @throws GyResourceException 
	*/
	public java.lang.String getSIPMethod() throws GyResourceException  {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new GyResourceException("Exception in getSIPMethod ",e);
		}
	}
}