...
import com.traffix.openblox.diameter.gy.generated.avp.AvpRemainingBalance;

public class RemainingBalanceAvp extends AvpDiameterGrouped {

	private static Logger logger = Logger.getLogger(RemainingBalanceAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpRemainingBalance stackObj;

	public RemainingBalanceAvp(AvpRemainingBalance stkObj){
		super(stkObj);
