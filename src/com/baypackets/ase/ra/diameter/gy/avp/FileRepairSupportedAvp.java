...
import com.traffix.openblox.diameter.gy.generated.avp.AvpFileRepairSupported;

public class FileRepairSupportedAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(FileRepairSupportedAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpFileRepairSupported stackObj;

	public FileRepairSupportedAvp(AvpFileRepairSupported stkObj){
		super(stkObj);
