...
import com.traffix.openblox.diameter.gy.generated.avp.AvpLocationEstimateType;

public class LocationEstimateTypeAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(LocationEstimateTypeAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpLocationEstimateType stackObj;

	public LocationEstimateTypeAvp(AvpLocationEstimateType stkObj){
		super(stkObj);
