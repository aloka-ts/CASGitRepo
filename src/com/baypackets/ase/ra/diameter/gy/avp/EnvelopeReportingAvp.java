...
import com.traffix.openblox.diameter.gy.generated.avp.AvpEnvelopeReporting;

public class EnvelopeReportingAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(EnvelopeReportingAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpEnvelopeReporting stackObj;

	public EnvelopeReportingAvp(AvpEnvelopeReporting stkObj){
		super(stkObj);
