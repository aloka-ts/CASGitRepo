...
import com.traffix.openblox.diameter.gy.generated.avp.AvpAddressType;

public class AddressTypeAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(AddressTypeAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpAddressType stackObj;

	public AddressTypeAvp(AvpAddressType stkObj){
		super(stkObj);
