...
import com.traffix.openblox.diameter.gy.generated.avp.AvpCurrentTariff;
import com.traffix.openblox.diameter.gy.generated.avp.AvpRateElement;

public class CurrentTariffAvp extends AvpDiameterGrouped {

	private static Logger logger = Logger.getLogger(CurrentTariffAvp.class.getName());
	
	public static final String name = "ErrorReportingHost";
	public static final int code = 294;
	public static final long vendorId = 0L;

	private AvpCurrentTariff stackObj;

	public CurrentTariffAvp(AvpCurrentTariff stkObj){
		super(stkObj);
