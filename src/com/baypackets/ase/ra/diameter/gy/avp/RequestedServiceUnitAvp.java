...
public class RequestedServiceUnitAvp extends AvpDiameterGrouped {

	private static Logger logger = Logger.getLogger(RequestedServiceUnitAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpRequestedServiceUnit stackObj;

	public RequestedServiceUnitAvp(AvpRequestedServiceUnit stkObj){
		super(stkObj);
