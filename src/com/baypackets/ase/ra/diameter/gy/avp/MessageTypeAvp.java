...
import com.traffix.openblox.diameter.gy.generated.avp.AvpMessageType;

public class MessageTypeAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(MessageTypeAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpMessageType stackObj;

	public MessageTypeAvp(AvpMessageType stkObj){
		super(stkObj);
