...
import com.traffix.openblox.diameter.gy.generated.avp.AvpScaleFactor;

public class ScaleFactorAvp extends AvpDiameterGrouped {

	private static Logger logger = Logger.getLogger(ScaleFactorAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpScaleFactor stackObj;

	public ScaleFactorAvp(AvpScaleFactor stkObj){
		super(stkObj);
