...
import com.traffix.openblox.diameter.gy.generated.avp.AvpMBMSServiceType;

public class MBMSServiceTypeAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(MBMSServiceTypeAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpMBMSServiceType stackObj;

	public MBMSServiceTypeAvp(AvpMBMSServiceType stkObj) { 
		super(stkObj);
