...
import com.traffix.openblox.diameter.gy.generated.avp.AvpAccountingRecordNumber;

public class AccountingRecordNumberAvp extends AvpDiameterUnsigned32 {

	private static Logger logger = Logger.getLogger(AccountingRecordNumberAvp.class.getName());
