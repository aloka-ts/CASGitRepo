...
import com.traffix.openblox.diameter.gy.generated.avp.AvpPoCServerRole;

public class PoCServerRoleAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(PoCServerRoleAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpPoCServerRole stackObj;

	public PoCServerRoleAvp(AvpPoCServerRole stkObj){
		super(stkObj);
