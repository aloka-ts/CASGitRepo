...
import com.traffix.openblox.diameter.gy.generated.avp.AvpPoCSessionType;

public class PoCSessionTypeAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(PoCSessionTypeAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpPoCSessionType stackObj;

	public PoCSessionTypeAvp(AvpPoCSessionType stkObj){
		super(stkObj);
