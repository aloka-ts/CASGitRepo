...
import com.traffix.openblox.diameter.gy.generated.avp.AvpLowBalanceIndication;

public class LowBalanceIndicationAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(LowBalanceIndicationAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpLowBalanceIndication stackObj;

	public LowBalanceIndicationAvp(AvpLowBalanceIndication stkObj){
		super(stkObj);
