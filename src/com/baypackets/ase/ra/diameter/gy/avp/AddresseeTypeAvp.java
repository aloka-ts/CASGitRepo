...
import com.traffix.openblox.diameter.gy.generated.avp.AvpAddresseeType;

public class AddresseeTypeAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(AddresseeTypeAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpAddresseeType stackObj; 

	public AddresseeTypeAvp(AvpAddresseeType stkObj){
		super(stkObj);
