...
import com.traffix.openblox.diameter.gy.generated.avp.AvpContentClass;

public class ContentClassAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(ContentClassAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpContentClass stackObj;

	public ContentClassAvp(AvpContentClass stkObj){
		super(stkObj);
