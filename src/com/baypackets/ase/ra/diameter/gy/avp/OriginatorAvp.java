...
import com.traffix.openblox.diameter.gy.generated.avp.AvpOriginator;

public class OriginatorAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(OriginatorAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpOriginator stackObj;

	public OriginatorAvp(AvpOriginator stkObj){
		super(stkObj);
