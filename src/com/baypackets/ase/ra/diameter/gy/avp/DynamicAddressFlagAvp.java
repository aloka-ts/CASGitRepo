...
import com.traffix.openblox.diameter.gy.generated.avp.AvpDynamicAddressFlag;

public class DynamicAddressFlagAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(DynamicAddressFlagAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpDynamicAddressFlag stackObj;

	public DynamicAddressFlagAvp(AvpDynamicAddressFlag stkObj){ 
		super(stkObj);
