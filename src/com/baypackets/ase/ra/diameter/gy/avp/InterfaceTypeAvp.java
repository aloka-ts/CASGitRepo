...
import com.traffix.openblox.diameter.gy.generated.avp.AvpInterfaceType;

public class InterfaceTypeAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(InterfaceTypeAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpInterfaceType stackObj;

	public InterfaceTypeAvp(AvpInterfaceType stkObj){
		super(stkObj);
