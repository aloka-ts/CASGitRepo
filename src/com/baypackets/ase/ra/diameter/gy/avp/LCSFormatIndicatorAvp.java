...
import com.traffix.openblox.diameter.gy.generated.avp.AvpLCSFormatIndicator;

public class LCSFormatIndicatorAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(LCSFormatIndicatorAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpLCSFormatIndicator stackObj;

	public LCSFormatIndicatorAvp(AvpLCSFormatIndicator  stkObj){
		super(stkObj);
