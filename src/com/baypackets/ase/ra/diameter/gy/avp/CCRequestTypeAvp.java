...
import com.traffix.openblox.diameter.gy.generated.avp.AvpCCRequestType;

public class CCRequestTypeAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(CCRequestTypeAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpCCRequestType stackObj;

	public CCRequestTypeAvp(AvpCCRequestType stkObj){
		super(stkObj);
