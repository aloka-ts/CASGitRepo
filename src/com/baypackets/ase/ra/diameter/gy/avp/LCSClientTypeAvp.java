...
import com.traffix.openblox.diameter.gy.generated.avp.AvpLCSClientType;

public class LCSClientTypeAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(LCSClientTypeAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpLCSClientType stackObj;

	public LCSClientTypeAvp(AvpLCSClientType stkObj){
		super(stkObj);
