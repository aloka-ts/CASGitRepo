...
import com.traffix.openblox.diameter.gy.generated.avp.AvpRATType;

public class RATTypeAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(RATTypeAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpRATType stackObj;

	public RATTypeAvp(AvpRATType stkObj){
		super(stkObj);
