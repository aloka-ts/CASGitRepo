...
public class InterOperatorIdentifierAvp extends AvpDiameterGrouped {
	 ...
	 */
	public OriginatingIOIAvp addOriginatingIOI(java.lang.String value) throws GyResourceException { 
		...
		try {
			...
			throw new GyResourceException("Exception in addOriginatingIOI",e);
		}
	}
	 ...
	 */
	public TerminatingIOIAvp addTerminatingIOI(java.lang.String value) throws GyResourceException { 
		...
		try {
			...
			throw new GyResourceException("Exception in addTerminatingIOI",e);
		}
	}
	 ...
	 */
	public java.lang.String getOriginatingIOI() throws GyResourceException { 
		...
		try {
			...
			throw new GyResourceException("Exception in getOriginatingIOI",e);
		}
	}
	 ...
	 */
	public java.lang.String getTerminatingIOI() throws GyResourceException { 
		...
		try {
			...
			throw new GyResourceException("Exception in getTerminatingIOI",e);
		}
	}
