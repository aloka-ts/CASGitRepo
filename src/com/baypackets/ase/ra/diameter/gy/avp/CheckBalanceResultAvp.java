...
import com.traffix.openblox.diameter.gy.generated.avp.AvpCheckBalanceResult;

public class CheckBalanceResultAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(CheckBalanceResultAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpCheckBalanceResult stackObj;

	public CheckBalanceResultAvp(AvpCheckBalanceResult stkObj){
		super(stkObj);
