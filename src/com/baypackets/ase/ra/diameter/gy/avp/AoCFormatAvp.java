...
import com.traffix.openblox.diameter.gy.generated.avp.AvpAoCFormat;

public class AoCFormatAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(AoCFormatAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpAoCFormat stackObj;

	public AoCFormatAvp(AvpAoCFormat stkObj){
		super(stkObj);
