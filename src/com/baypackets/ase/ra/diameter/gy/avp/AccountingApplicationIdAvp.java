...
import com.traffix.openblox.diameter.gy.generated.avp.AvpAccountingApplicationId;

public class AccountingApplicationIdAvp extends AvpDiameterUnsigned32 {

	private static Logger logger = Logger.getLogger(AccountingApplicationIdAvp.class.getName());
