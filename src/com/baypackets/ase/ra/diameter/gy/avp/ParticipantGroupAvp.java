...
public class ParticipantGroupAvp extends AvpDiameterGrouped {

	private static Logger logger = Logger.getLogger(ParticipantGroupAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpParticipantGroup stackObj;

	public ParticipantGroupAvp(AvpParticipantGroup stkObj){
		super(stkObj);
