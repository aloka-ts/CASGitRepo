...
import com.traffix.openblox.diameter.gy.generated.avp.AvpServiceContextId;

public class ServiceContextIdAvp extends AvpDiameterUTF8String {

	private static Logger logger = Logger.getLogger(ServiceContextIdAvp.class.getName());
