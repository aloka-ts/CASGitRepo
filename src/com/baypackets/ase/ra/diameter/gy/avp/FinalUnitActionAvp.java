...
import com.traffix.openblox.diameter.gy.generated.avp.AvpFinalUnitAction;

public class FinalUnitActionAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(FinalUnitActionAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpFinalUnitAction stackObj;

	public FinalUnitActionAvp(AvpFinalUnitAction stkObj){
		super(stkObj);
