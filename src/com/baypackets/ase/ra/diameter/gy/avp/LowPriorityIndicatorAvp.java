...
import com.traffix.openblox.diameter.gy.generated.avp.AvpLowPriorityIndicator;

public class LowPriorityIndicatorAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(LowPriorityIndicatorAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpLowPriorityIndicator stackObj;

	public LowPriorityIndicatorAvp(AvpLowPriorityIndicator stkObj){
		super(stkObj);
