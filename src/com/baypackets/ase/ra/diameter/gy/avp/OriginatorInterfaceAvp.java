...
import com.traffix.openblox.diameter.gy.generated.avp.AvpOriginatorInterface;
import com.traffix.openblox.diameter.gy.generated.enums.EnumInterfaceType;

public class OriginatorInterfaceAvp extends AvpDiameterGrouped {

	private static Logger logger = Logger.getLogger(OriginatorInterfaceAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpOriginatorInterface stackObj;

	public OriginatorInterfaceAvp(AvpOriginatorInterface stkObj){
		super(stkObj);
	 ...
	 */
	public InterfaceTypeAvp addInterfaceType(InterfaceTypeEnum value) throws GyResourceException { 

		try {
			if(logger.isDebugEnabled()){
				logger.debug("Inside addInterfaceType()");
			}
			return new InterfaceTypeAvp(stackObj.addInterfaceType(InterfaceTypeEnum.getStackObj(value)));
		} catch (ValidationException e) {
	...
	/**
	 *  Retrieves Enum of InterfaceType.
	 */
