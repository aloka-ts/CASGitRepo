...
import com.traffix.openblox.diameter.gy.generated.avp.AvpMBMS2G3GIndicator;

public class MBMS2G3GIndicatorAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(MBMS2G3GIndicatorAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpMBMS2G3GIndicator stackObj;

	public MBMS2G3GIndicatorAvp(AvpMBMS2G3GIndicator stkObj){
		super(stkObj);
