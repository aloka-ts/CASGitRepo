...
import com.traffix.openblox.diameter.gy.generated.avp.AvpPoCEventType;

public class PoCEventTypeAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(PoCEventTypeAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpPoCEventType stackObj;

	public PoCEventTypeAvp(AvpPoCEventType stkObj){
		super(stkObj);
