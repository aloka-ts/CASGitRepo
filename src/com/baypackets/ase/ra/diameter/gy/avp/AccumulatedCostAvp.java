...
import com.traffix.openblox.diameter.gy.generated.avp.AvpAccumulatedCost;

public class AccumulatedCostAvp extends AvpDiameterGrouped {

	private static Logger logger = Logger.getLogger(AccumulatedCostAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpAccumulatedCost stackObj;

	public AccumulatedCostAvp(AvpAccumulatedCost stkObj){
		super(stkObj);
