...
import com.traffix.openblox.diameter.gy.generated.avp.AvpServerCapabilities;
...
public class ServerCapabilitiesAvp extends AvpDiameterGrouped {
	 ...
	 */
	public MandatoryCapabilityAvp addMandatoryCapability(long value) throws GyResourceException {
		try {
			...
			throw new GyResourceException("Exception in addMandatoryCapability",e);
		}
	}
	 ...
	 */
	public OptionalCapabilityAvp addOptionalCapability(long value) throws GyResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new GyResourceException("Exception in addOptionalCapability",e);
		}
	}
	 ...
	 */
	public ServerNameAvp addServerName(java.lang.String value) throws GyResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new GyResourceException("Exception in addServerName",e);
		}
	}
	 ...
	 */
	public long[] getMandatoryCapabilitys( ) throws GyResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new GyResourceException("Exception in getMandatoryCapabilitys",e);
		}
	}
	 ...
	 */
	public long[] getOptionalCapabilitys( ) throws GyResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new GyResourceException("Exception in getOptionalCapabilitys",e);
		}
	}
	 ...
	 */
	public java.lang.String[] getServerNames( ) throws GyResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new GyResourceException("Exception in getServerNames",e);
		}
	}
