...
import com.traffix.openblox.diameter.gy.generated.avp.AvpRealTimeTariffInformation;
...
public class RealTimeTariffInformationAvp extends AvpDiameterGrouped {
	 ...
	 */
	public TariffXMLAvp addTariffXML(java.lang.String value) throws GyResourceException { 
		...
		try {
			...
			throw new GyResourceException("Exception in addTariffXML",e);
		}
	}
	 ...
	 */
	public java.lang.String getTariffXML() throws GyResourceException { 
		...
		try {
			...
			throw new GyResourceException("Exception in getTariffXML",e);
		}
	}
