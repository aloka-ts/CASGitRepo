...
import com.traffix.openblox.diameter.gy.generated.avp.AvpMBMSUserServiceType;

public class MBMSUserServiceTypeAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(MBMSUserServiceTypeAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpMBMSUserServiceType stackObj;

	public MBMSUserServiceTypeAvp(AvpMBMSUserServiceType stkObj){
		super(stkObj);
