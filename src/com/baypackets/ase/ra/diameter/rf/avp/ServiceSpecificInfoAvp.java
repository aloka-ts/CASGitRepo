...
public class ServiceSpecificInfoAvp extends AvpDiameterGrouped {
	...
	*/
	public ServiceSpecificDataAvp addServiceSpecificData(java.lang.String value) throws RfResourceException  {
		try {
			...
			throw new RfResourceException("Exception in addServiceSpecificData ",e);
		}
	}
	...
	*/
	public ServiceSpecificTypeAvp addServiceSpecificType(long value) throws RfResourceException  {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addServiceSpecificType ",e);
		}
	}
	...
	*/
	public java.lang.String getServiceSpecificData() throws RfResourceException  {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in getServiceSpecificData ",e);
		}
	}
	...
	*/
	public long getServiceSpecificType() throws RfResourceException  {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in getServiceSpecificType ",e);
		}
	}
}