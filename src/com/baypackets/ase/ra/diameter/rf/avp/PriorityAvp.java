...
import com.traffix.openblox.diameter.rf.generated.avp.AvpPriority;

public class PriorityAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(PriorityAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpPriority stackObj;

	public PriorityAvp(AvpPriority stkObj){
		super(stkObj);
