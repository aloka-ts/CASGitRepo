...
import com.traffix.openblox.diameter.rf.generated.avp.AvpDRMContent;

public class DRMContentAvp extends AvpDiameterEnumerated {

	private static Logger logger = Logger.getLogger(DRMContentAvp.class.getName());
	public static final long vendorId = 0L;

	private AvpDRMContent stackObj;

	public DRMContentAvp(AvpDRMContent stkObj){
		super(stkObj);
