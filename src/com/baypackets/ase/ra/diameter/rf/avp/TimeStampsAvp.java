...
import com.traffix.openblox.diameter.rf.generated.avp.AvpTimeStamps;
...
public class TimeStampsAvp extends AvpDiameterGrouped {
	 ...
	 */
	public SIPRequestTimestampAvp addSIPRequestTimestamp(java.util.Date value) throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in addSIPRequestTimestamp",e);
		}
	}
	 ...
	 */
	public SIPRequestTimestampFractionAvp addSIPRequestTimestampFraction(long value) throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in addSIPRequestTimestampFraction",e);
		}
	}
	 ...
	 */
	public SIPResponseTimestampAvp addSIPResponseTimestamp(java.util.Date value) throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in addSIPResponseTimestamp",e);
		}
	}
	 ...
	 */
	public SIPResponseTimestampFractionAvp addSIPResponseTimestampFraction(long value) throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in addSIPResponseTimestampFraction",e);
		}
	}
	 ...
	 */
	public java.util.Date getSIPRequestTimestamp() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getSIPRequestTimestamp",e);
		}
	}
	 ...
	 */
	public long getSIPRequestTimestampFraction() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getSIPRequestTimestampFraction",e);
		}
	}
	 ...
	 */
	public java.util.Date getSIPResponseTimestamp() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getSIPResponseTimestamp",e);
		}
	}
	 ...
	 */
	public long getSIPResponseTimestampFraction() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getSIPResponseTimestampFraction",e);
		}
	}
