...
import com.baypackets.ase.ra.diameter.rf.enums.OnlineChargingFlagEnum;
import com.baypackets.ase.ra.diameter.rf.enums.RoleOfNodeEnum;
import com.traffix.openblox.core.exceptions.ValidationException;
import com.traffix.openblox.diameter.rf.generated.avp.AvpApplicationServerInformation;
import com.traffix.openblox.diameter.rf.generated.avp.AvpIMSInformation;
...
import com.traffix.openblox.diameter.rf.generated.avp.AvpServiceSpecificInfo;
import com.traffix.openblox.diameter.rf.generated.enums.EnumNodeFunctionality;
...
public class IMSInformationAvp extends AvpDiameterGrouped {
	 ...
	 */
	public AccessNetworkInformationAvp	addAccessNetworkInformation(byte[] value) throws RfResourceException {
		try {
			...
			throw new RfResourceException("Exception in addAccessNetworkInformation ",e);
		}
	}
	 ...
	 * @return
	 */
	public AccessNetworkInformationAvp	addAccessNetworkInformation(java.lang.String value) throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
				logger.debug("Inside addAccessNetworkInformation()");
			}
	 ...
	 * @return
	 */
	public AlternateChargedPartyAddressAvp 	addAlternateChargedPartyAddress(java.lang.String value) throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addAlternateChargedPartyAddress ",e);
		}
	}
	 ...
	 * @return
	 */
	public AssociatedURIAvp 	addAssociatedURI(java.lang.String value)  throws RfResourceException{
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addAssociatedURI ",e);
		}	
	}
	 ...
	 * @return
	 */
	public BearerServiceAvp 	addBearerService(byte[] value) throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addBearerService ",e);
		}
	}
	 ...
	 * @return
	 */
	public BearerServiceAvp 	addBearerService(java.lang.String value) throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
				logger.debug("Inside addBearerService()");
			}
	 ...
	 * @return
	 */
	public CalledAssertedIdentityAvp 	addCalledAssertedIdentity(java.lang.String value)  throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addCalledAssertedIdentity ",e);
		}
	}
	 ...
	 * @return
	 */
	public CalledPartyAddressAvp 	addCalledPartyAddress(java.lang.String value) throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addCalledPartyAddress ",e);
		}
	}
	 ...
	 * @return
	 */
	public CallingPartyAddressAvp 	addCallingPartyAddress(java.lang.String value) throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addCallingPartyAddress ",e);
		}
	}
	 ...
	 * @return
	 */
	public CarrierSelectRoutingInformationAvp 	addCarrierSelectRoutingInformation(java.lang.String value) throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addCarrierSelectRoutingInformation ",e);
		}
	}
	 ...
	 * @return
	 */
	public CauseCodeAvp 	addCauseCode(int value)  throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addCauseCode ",e);
		}
	}
	 ...
	 * @return
	 */
	public ApplicationServerInformationAvp 	addGroupedApplicationServerInformation() throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addGroupedApplicationServerInformation ",e);
		}
	}
	 ...
	 * @return
	 */
	public EventTypeAvp 	addGroupedEventType() throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addGroupedEventType ",e);
		}
	}
	 ...
	 * @return
	 */
	public InterOperatorIdentifierAvp 	addGroupedInterOperatorIdentifier() throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addGroupedInterOperatorIdentifier ",e);
		}
	}
	 ...
	 * @return
	 */
	public MessageBodyAvp 	addGroupedMessageBody() throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addGroupedMessageBody ",e);
		}
	}
	 ...
	 * @return
	 */
	public RealTimeTariffInformationAvp 	addGroupedRealTimeTariffInformation() throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addGroupedRealTimeTariffInformation ",e);
		}
	}
	 ...
	 * @return
	 */
	public SDPMediaComponentAvp 	addGroupedSDPMediaComponent() throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addGroupedSDPMediaComponent ",e);
		}
	}
	 ...
	 * @return
	 */
	public ServerCapabilitiesAvp 	addGroupedServerCapabilities() throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addGroupedServerCapabilities ",e);
		}
	}
	 ...
	 * @return
	 */
	public ServiceSpecificInfoAvp addGroupedServiceSpecificInfo() throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addGroupedServiceSpecificInfo ",e);
		}
	}
	 ...
	 * @return
	 */
	public TimeStampsAvp addGroupedTimeStamps() throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addGroupedTimeStamps ",e);
		}
	}
	 ...
	 * @return
	 */
	public TrunkGroupIdAvp addGroupedTrunkGroupId() throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addGroupedTrunkGroupId ",e);
		}
	}
	 ...
	 * @return
	 */
	public IMSChargingIdentifierAvp addIMSChargingIdentifier(java.lang.String value) throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addIMSChargingIdentifier ",e);
		}
	}
	 ...
	 * @return
	 */
	public IMSCommunicationServiceIdentifierAvp 	addIMSCommunicationServiceIdentifier(java.lang.String value) throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addIMSCommunicationServiceIdentifier ",e);
		}
	}
	 ...
	 * @return
	 */
	public NodeFunctionalityAvp 	addNodeFunctionality(EnumNodeFunctionality value) throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addNodeFunctionality ",e);
		}
	}
	 ...
	 * @return
	 */
	public NumberPortabilityRoutingInformationAvp 	addNumberPortabilityRoutingInformation(java.lang.String value) throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addNumberPortabilityRoutingInformation ",e);
		}
	}
	 ...
	 * @return
	 */
	public OnlineChargingFlagAvp 	addOnlineChargingFlag(EnumOnlineChargingFlag value) throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addOnlineChargingFlag ",e);
		}
	}
	 ...
	 * @return
	 */
	public RequestedPartyAddressAvp 	addRequestedPartyAddress(java.lang.String value) throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addRequestedPartyAddress ",e);
		}
	}
	 ...
	 * @return
	 */
	public RoleOfNodeAvp 	addRoleOfNode(EnumRoleOfNode value) throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addRoleOfNode ",e);
		}
	}
	 ...
	 * @return
	 */
	SDPSessionDescriptionAvp addSDPSessionDescription(java.lang.String value) throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addSDPSessionDescription ",e);
		}
	}
	 ...
	 * @return
	 */
	ServedPartyIPAddressAvp 	addServedPartyIPAddress(byte[] value) throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addServedPartyIPAddress ",e);
		}
	}
	 ...
	 * @return
	 */
	ServedPartyIPAddressAvp 	addServedPartyIPAddress(java.net.InetAddress value) throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
				logger.debug("Inside addServedPartyIPAddress()");
			}
	 ...
	 * @return
	 */
	public ServiceIdAvp 	addServiceId(java.lang.String value) throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addServiceId ",e);
		}
	}
	 ...
	 * @throws RfResourceException 
	 */
	public UserSessionIdAvp 	addUserSessionId(java.lang.String value) throws RfResourceException {
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in addUserSessionId ",e);
		}
	}
	 ...
	 */
	public java.lang.String getAccessNetworkInformation() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getAccessNetworkInformation",e);
		}
	}
	 ...
	 */
	public java.lang.String getAlternateChargedPartyAddress() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getAlternateChargedPartyAddress",e);
		}
	}
	 ...
	 */
	public java.lang.String[] getAssociatedURIs() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getAssociatedURIs",e);
		}
	}
	 ...
	 */
	public java.lang.String getBearerService() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getBearerService",e);
		}
	}
	 ...
	 */
	public java.lang.String[] getCalledAssertedIdentitys() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getCalledAssertedIdentitys",e);
		}
	}
	 ...
	 */
	public java.lang.String getCalledPartyAddress() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getCalledPartyAddress",e);
		}
	}
	 ...
	 */
	public java.lang.String[] getCallingPartyAddresss() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getCallingPartyAddresss",e);
		}
	}
	 ...
	 */
	public java.lang.String getCarrierSelectRoutingInformation() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getCarrierSelectRoutingInformation",e);
		}
	}
	 ...
	 */
	public int getCauseCode() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getCauseCode",e);
		}
	}
...
//	 */
//	public NodeFunctionalityEnum getEnumNodeFunctionality() throws RfResourceException { 
//		try {
//			if(logger.isDebugEnabled()){
...
//		} catch (ValidationException e) {
//			throw new RfResourceException("Exception in getEnumNodeFunctionality ",e);
//		}
//	}
	 ...
	 */
	public OnlineChargingFlagEnum getEnumOnlineChargingFlag() throws RfResourceException { 
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in getEnumOnlineChargingFlag ",e);
		}
	}
	 ...
	 */
	public RoleOfNodeEnum getEnumRoleOfNode() throws RfResourceException { 
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in OnlineChargingFlagEnum ",e);
		}
	}
	 ...
	 */
	public ApplicationServerInformationAvp[] getGroupedApplicationServerInformations() throws RfResourceException { 
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in getGroupedApplicationServerInformations",e);
		}
	}
//
//	/**
...
//	 */
//	public EarlyMediaDescriptionAvp[] getGroupedEarlyMediaDescriptions() throws RfResourceException { 
//		try {
//			if(logger.isDebugEnabled()){
...
//			return contAvp;
//		} catch (ValidationException e) {
//			throw new RfResourceException("Exception in getGroupedEarlyMediaDescriptions",e);
//		}
//	}
	 ...
	 */
	public EventTypeAvp getGroupedEventType() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getGroupedEventType",e);
		}
	}
	 ...
	 */
	public InterOperatorIdentifierAvp[] getGroupedInterOperatorIdentifiers() throws RfResourceException { 
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in getGroupedInterOperatorIdentifiers",e);
		}
	}
	 ...
	 */
	public MessageBodyAvp[] getGroupedMessageBodys() throws RfResourceException { 
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in getGroupedMessageBodys",e);
		}
	}
	 ...
	 */
	public RealTimeTariffInformationAvp getGroupedRealTimeTariffInformation() throws RfResourceException { 
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in getGroupedRealTimeTariffInformation",e);
		}
	}
	 ...
	 */
	public SDPMediaComponentAvp[] getGroupedSDPMediaComponents() throws RfResourceException { 
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in getGroupedSDPMediaComponents",e);
		}
	}
	 ...
	 */
	public ServerCapabilitiesAvp getGroupedServerCapabilities() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getGroupedServerCapabilities",e);
		}
	}
	 ...
	 */
	public ServiceSpecificInfoAvp[] getGroupedServiceSpecificInfos() throws RfResourceException { 
		try {
			if(logger.isDebugEnabled()){
			...
			throw new RfResourceException("Exception in getGroupedServiceSpecificInfos",e);
		}
	}
	 ...
	 */
	public TimeStampsAvp getGroupedTimeStamps() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getGroupedTimeStamps",e);
		}
	}
	 ...
	 */
	public TrunkGroupIdAvp getGroupedTrunkGroupId() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getGroupedTrunkGroupId",e);
		}
	}
	 ...
	 */
	public java.lang.String getIMSChargingIdentifier() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getIMSChargingIdentifier",e);
		}
	}
	 ...
	 */
	public java.lang.String getIMSCommunicationServiceIdentifier() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getIMSCommunicationServiceIdentifier",e);
		}
	}
	 ...
	 */
	public int getNodeFunctionality() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getNodeFunctionality",e);
		}
	}
	 ...
	 */
	public java.lang.String getNumberPortabilityRoutingInformation() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getNumberPortabilityRoutingInformation",e);
		}
	}
	 ...
	 */
	public int getOnlineChargingFlag() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getOnlineChargingFlag",e);
		}
	}
	 ...
	 *  Retrieving a single OctetString value from AccessNetworkInformation AVPs.
	 */
	public byte[] getRawAccessNetworkInformation() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getRawAccessNetworkInformation",e);
		}
	}
	 ...
	 *  Retrieving a single OctetString value from BearerService AVPs.
	 */
	public byte[] getRawBearerService() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getRawBearerService",e);
		}
	}
	 ...
	 */
	public byte[] getRawServedPartyIPAddress() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getRawServedPartyIPAddress",e);
		}
	}
	 ...
	 */
	public java.lang.String getRequestedPartyAddress() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getRequestedPartyAddress",e);
		}
	}
	 ...
	 */
	public int getRoleOfNode() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getRoleOfNode",e);
		}
	}
	 ...
	 */
	public java.lang.String[] getSDPSessionDescriptions() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getSDPSessionDescriptions",e);
		}
	}
	 ...
	 *  Retrieving a single Address value from ServedPartyIPAddress AVPs.
	 */
	public java.net.InetAddress getServedPartyIPAddress() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getServedPartyIPAddress",e);
		}
	}
	 ...
	 */
	public java.lang.String getServiceId() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getServiceId",e);
		}
	}
	 ...
	 */
	public java.lang.String getUserSessionId() throws RfResourceException { 
		...
		try {
			...
			throw new RfResourceException("Exception in getUserSessionId",e);
		}
	}
