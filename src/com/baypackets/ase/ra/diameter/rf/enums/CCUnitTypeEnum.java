...
import com.traffix.openblox.diameter.rf.generated.enums.EnumCCUnitType;
	...
	public enum CCUnitTypeEnum
	{
		...
		/**
		 * This method returns the Container wrapper class for stack's EnumCCUnitType class.
		 * @param shEnum
		 * @return
		 */
		public static final CCUnitTypeEnum getContainerObj(EnumCCUnitType shEnum){
			return containerMapping.get(shEnum);
		}

		/**
		 * This method returns the EnumCCUnitType class for Container wrapper class.
		 * @param shEnum
		 * @return
		 */
		public static final EnumCCUnitType getStackObj(CCUnitTypeEnum shEnum){
