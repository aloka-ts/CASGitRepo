...
public class RulesRepositoryImpl implements RulesRepository
{
	...
	private static final Logger logger = Logger.getLogger(RulesRepositoryImpl.class);
	 ...
	 */
	public ArrayList generateRules(InputStream stream) throws SHParseRulesException {
		...
		try {
			...
			logger.error(msg,e);
			throw new SHParseRulesException(msg + e.getMessage());
		}           
	}
	...
	@Override
	public String findMatchingRule(ShRequest req) {
		logger.debug("Inside findMatchingRule " +ruleList.size());
		try {
