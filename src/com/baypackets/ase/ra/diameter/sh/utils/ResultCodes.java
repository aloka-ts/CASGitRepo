...
public class ResultCodes {
	...
	private static Logger logger = Logger.getLogger(ResultCodes.class);
...
//   			case 5011:returnCode = "DIAMETER_UNSUPPORTED_VERSION" ; break;
   			...
   			case 5100: returnCode= "DIAMETER_ERROR_USER_DATA_NOT_RECOGNIZED";break;
   			case 5101: returnCode= "DIAMETER_ERROR_OPERATION_NOT_ALLOWED";break;
   			case 5102: returnCode="DIAMETER_ERROR_USER_DATA_CANNOT_BE_READ";break;
   			case 5103: returnCode="DIAMETER_ERROR_USER_DATA_CANNOT_BE_MODIFIED";break;
   			case 5104: returnCode="DIAMETER_ERROR_USER_DATA_CANNOT_BE_NOTIFIED";break;
   			case 5008: returnCode="DIAMETER_ERROR_TOO_MUCH_DATA";break;
   			case 5105:returnCode="DIAMETER_ERROR_TRANSPARENT_DATA_OUT_OF_SYNC";break;
   			case 5011:returnCode="DIAMETER_ERROR_FEATURE_UNSUPPORTED";break;
   			case 5106:returnCode="DIAMETER_ERROR_SUBS_DATA_ABSENT";break;
   			case 5107:returnCode="DIAMETER_ERROR_NO_SUBSCRIPTION_TO_DATA";break;
   			case 5108:returnCode="DIAMETER_ERROR_DSAI_NOT_AVAILABLE";break;
   			case 5002:returnCode="DIAMETER_ERROR_IDENTITIES_DONT_MATCH";break;
   			case 4100:returnCode="DIAMETER_USER_DATA_NOT_AVAILABLE";break;
   			case 4101:returnCode="DIAMETER_PRIOR_UPDATE_IN_PROGRESS";break;
   			default: returnCode = "DIAMETER_SUCCESS";
   			
   			}
   		}
   		logger.debug("Result codes returned value :- " + returnCode);
 	return returnCode;
   	}
       
       
       static public String getExperimentalResultCode(int codeString){
      		String returnCode = "DIAMETER_SUCCESS"; // SUCCESS
      		
      		if(logger.isDebugEnabled()){
      			logger.debug("getExperimentalResultCode  for code "+ codeString);
      		}
      		...
      		if(codeString !=-1){
      			...
      			case 4011: returnCode = "DIAMETER_CREDIT_CONTROL_NOT_APPLICABLE";break;
      			case 4012: returnCode = "DIAMETER_CREDIT_LIMIT_REACHED";break;
      			case 5001: returnCode = "DIAMETER_ERROR_USER_UNKNOWN"; break;
      		//	case 5002: returnCode = "DIAMETER_UNKNOWN_SESSION_ID" ; break;
      			case 5003: returnCode = "DIAMETER_AUTHORIZATION_REJECTED"; break;
      			case 5004: returnCode = "DIAMETER_INVALID_AVP_VALUE"; break;
      			case 5005: returnCode = "DIAMETER_MISSING_AVP"     ; break;
...
//      			case 5011:returnCode = "DIAMETER_UNSUPPORTED_VERSION" ; break;
      		...
      		logger.debug("Exp Result codes returned value :- " + returnCode);
    	return returnCode;
      	}
...
//	static public String getExperimentalResultCode(int codeString) {
//		String returnCode = null;//"DIAMETER_SUCCESS"; // SUCCESS
//
//		if (codeString != -1) {
//			switch (codeString) {
//			case 2001:
...
//			case 5001:
//				returnCode = "DIAMETER_ERROR_USER_UNKNOWN";
//				break;
//
//			default:
//				returnCode = null;
