...
import com.baypackets.ase.ra.diameter.sh.ShProfileUpdateResponse;
import com.baypackets.ase.ra.diameter.sh.impl.ShSession;
import com.baypackets.ase.resource.Request;

import java.util.ArrayList;

public class ShProfileUpdateResponseImpl extends ShAbstractResponse implements ShProfileUpdateResponse {
	...
	private static Logger logger = Logger.getLogger(ShProfileUpdateResponseImpl.class);
	...
	public ShProfileUpdateResponseImpl(int answer, ShUserDataRequestImpl containerReq){
		super(answer);
		if(logger.isDebugEnabled()){
			logger.debug("Inside ShProfileUpdateResponseImpl constructor answer " +answer +" from Request " +containerReq);
		}
	...
	public ShProfileUpdateResponseImpl(ShSession ShSession){
		super(ShSession);
	...
	public ShProfileUpdateResponseImpl(DiameterMessage stkObj){
		super(stkObj);

		super.stackObj=stkObj;

		if(logger.isDebugEnabled()){
			logger.debug("Inside ShProfileUpdateResponseImpl constructor stackObj " +stkObj);
		}
	...
	////////////////////////////////////////////////////////////////////
	////////////// ShProfileUpdateResponse Specific API ENDS  ///////////////
	////////////////////////////////////////////////////////////////////
