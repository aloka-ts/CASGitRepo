...
public class ShSubscribeNotificationRequestImpl extends ShAbstractRequest implements ShSubscribeNotificationRequest {
	private static final long serialVersionUID = 1L;
	private static Logger logger = Logger.getLogger(ShSubscribeNotificationRequestImpl.class);
	...
	//	public ShSubscribeNotificationRequestImpl(int type){
	//		super(type);
	...
	public ShSubscribeNotificationRequestImpl(ShSession shSession, int type, String remoteRealm,String msisdn){
		super(shSession);
		logger.debug("Inside ShSubscribeNotificationRequestImpl(ShSession) constructor ");
