...
public class MsOneWayDialoutHandler extends OneWayDialoutHandler{

	private transient MsSessionControllerImpl msSession = null;
	private static final long serialVersionUID = -4569847543333637L;
	/**
	 * Public Default Constructor used for Externalizing this Object
	 */
	public MsOneWayDialoutHandler() {
		super();
	}
	
	public MsOneWayDialoutHandler(Address addressB) {
		super(null, addressB);
	}
