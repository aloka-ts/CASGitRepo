 ...
 * </pre> </code>
 */
public final class AseSipDiversionHeader extends DsSipNameAddressHeader
{
	/** Header Token. */
	public static final DsByteString m_token = new DsByteString("Diversion") ;
	/** Header TokenC. */
	    public static final DsByteString m_tokenC = new DsByteString("Diversion:") ;
	/** Index tag token*/
     ...
     */
    public AseSipDiversionHeader(byte[] value)
     ...
     *            detected by this header as a Parser Listener, while parsing.
     */
    public AseSipDiversionHeader(byte[] value, int offset, int count)
        throws DsSipParserException, DsSipParserListenerException
    {
     ...
     *            detected by this header as a Parser Listener, while parsing.
     */
    public AseSipDiversionHeader(DsByteString value)
        throws DsSipParserException, DsSipParserListenerException
    {
     ...
     */
    public AseSipDiversionHeader(DsSipNameAddress nameAddress)
    {
     ...
     */
    public AseSipDiversionHeader(DsSipNameAddress nameAddress, DsParameters parameters)
    {
     ...
     */
    public AseSipDiversionHeader(DsURI uri)
    {
        super(uri);
    }
     ...
     * @param parameters the list of parameters for this header.
     */
    public AseSipDiversionHeader(DsURI uri, DsParameters parameters)
    {
    ...
    {
        super.copy(header);
        AseSipDiversionHeader source = (AseSipDiversionHeader)header;
    ...
    public boolean equals(Object obj)
    {
        ...
        AseSipDiversionHeader header = null;
        try
        {
            header = (AseSipDiversionHeader)obj;
			if(header == null)
				return false;
        }
