/**
 * AseSipProxyMessageMessageHandler.java
 */
...
class AseSipProxyMessageMessageHandler extends AseSipProxyDefaultMessageHandler {
	 ...
	 transient private static Logger m_logger =
		  Logger.getLogger(AseSipProxyMessageMessageHandler.class);
}
