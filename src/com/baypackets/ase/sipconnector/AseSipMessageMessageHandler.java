/**
 * AseSipMessageMessageHandler.java
 */
...
class AseSipMessageMessageHandler extends AseSipDefaultMessageHandler {
	 ...
	 transient private static Logger m_logger =
		  Logger.getLogger(AseSipMessageMessageHandler.class);
}
