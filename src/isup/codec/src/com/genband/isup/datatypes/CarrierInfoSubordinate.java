 ...
 *
 */
public class CarrierInfoSubordinate
{
	/**
	...
	public int getCarrierInfoSubOrdinateLength() {
		return carrierInfoSubOrdinateLength;
	}

	public void setCarrierInfoSubOrdinateLength(int carrierInfoSubOrdinateLength) {
		this.carrierInfoSubOrdinateLength = carrierInfoSubOrdinateLength;
	}
