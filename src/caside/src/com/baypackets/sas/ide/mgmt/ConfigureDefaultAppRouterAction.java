...
public class ConfigureDefaultAppRouterAction implements IWorkbenchWindowActionDelegate
{
	...
	public void run(IAction action) {
		...
		SasPlugin.getDefault().log("Inside Configure data source action");
		   ...
		   IPath pathASEHOME = JavaCore.getClasspathVariable("ASE_HOME");
			...
			fileStore = fileStore.getChild(new Path("dar.properties"));

			  SasPlugin.getDefault().log("Default App router file path found in file store open with CAS editor "+fileStore);
			...
			if (fileStore != null) {
				...
				MessageDialog messageBox = new MessageDialog(
						...
						"Configure File",
						null,
						" The Default App Router configuration file doesnot exist",
