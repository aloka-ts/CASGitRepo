...
public class ConfigureCASASEProperties implements IWorkbenchWindowActionDelegate
{
	...
	public void run(IAction action) {
		...
		SasPlugin.getDefault().log("Inside Configure ase.properties");
		   ...
		   IPath pathASEHOME = JavaCore.getClasspathVariable("ASE_HOME");
			...
			fileStore = fileStore.getChild(new Path("ase.properties"));

			  SasPlugin.getDefault().log("ase.properties file path found in file store open with CAS editor "+fileStore);
			...
			if (fileStore != null) {
				...
				MessageDialog messageBox = new MessageDialog(
						...
						"Configure File",
						null,
						" The ase.properties configuration file doesnot exist",
