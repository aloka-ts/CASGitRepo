...
public class HttpInitParamSection extends SectionPart implements ModelListener{
	...
	public HttpInitParamSection(BPFormPage page, Composite parent) {
	...
	public class InitParamContentProvider implements IStructuredContentProvider{
		...
		//	System.out.println("getElements inputElement is........ "+inputElement);
