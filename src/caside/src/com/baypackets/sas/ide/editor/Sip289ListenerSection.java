...
public class Sip289ListenerSection extends SectionPart implements ModelListener {
	
	private static final String LISTENER = "listener".intern();
	private static final String LISTENER_CLASS = "javaee:listener-class".intern();
	
	private BPFormPage page;
	
	public Sip289ListenerSection(BPFormPage page, Composite parent) {
