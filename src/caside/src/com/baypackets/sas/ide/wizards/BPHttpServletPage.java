...
public static final String LINE_DELIMITER = "\n";
	...
	private static final String[] REQ_PARAM_TYPES = new String[] {HTTP_SERVLET_REQUEST,HTTP_SERVLET_RESPONSE};
	private static final String[] REQ_PARAM_NAMES = new String[] {"request".intern(),"response".intern()};
