...
public class ServiceInfoDialog extends Dialog 
{
	...
	public Object open () 
	{
		...
		try
		{
			...
			serviceAppSessionTimeoutLabel.setLocation(60,300);
			...
			textServiceAppSessionTimeout.setLocation(220,300);
			...
			serviceActiveAppSessionLabel.setLocation(60,330);
			...
			textServiceActiveAppSession.setLocation(220,330);
			...
			serviceDistributableLabel.setLocation(60,360);
			...
			textServiceDistributable.setLocation(220,360);
	...
	private void fillServiceParameters()
	{
		try
		{
			Set serv = ASEServices.keySet();
				...
				//if(!(str.trim().equals(ServiceName.trim())))
				...
				while(st.hasMoreTokens())
				{
					...
					if(key.trim().equals("Name"))
						textServiceName.setText(val);

					else if(key.trim().equals("Version"))
						textServiceVersion.setText(val);
					else if(key.trim().equals("Priority"))
						textServicePriority.setText(val);
					else if(key.trim().equals("Display Name"))
						textServiceDisplayName.setText(val);
					else if(key.trim().equals("Distributable"))
						textServiceDistributable.setText(val);
					else if(key.trim().equals("Application Session Timeout (min)"))
						textServiceAppSessionTimeout.setText(val);
					else if(key.trim().equals("Number of ACTIVE Application Sessions"))
				...
				//	SasPlugin.getDefault().log("PROP ==== > "+prop);
					...
					if(deployed.equals("CLIENT_IDE"))
						textServiceDeployedBy.setText("CAS IDE");
					else
