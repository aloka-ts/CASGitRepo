...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1BoxedType ( name = "QualificationRequest2Res" )
    public class QualificationRequest2Res implements IASN1PreparedElement {
                
        

       @ASN1PreparedElement
       @ASN1Sequence ( name = "QualificationRequest2Res" , isSet = true )
       public static class QualificationRequest2ResSequenceType implements IASN1PreparedElement {
	...
	private ServiceRedirectionInfo serviceRedirectionInfo = null;
        ...
        public IASN1PreparedElementData getPreparedData() {
            return preparedData_QualificationRequest2ResSequenceType;
        }

       private static IASN1PreparedElementData preparedData_QualificationRequest2ResSequenceType = CoderFactory.getInstance().newPreparedElementData(QualificationRequest2ResSequenceType.class);
                
       }

       
                
        @ASN1Element ( name = "QualificationRequest2Res", isOptional =  false , hasTag =  true, tag = 18, 
        tagClass =  TagClass.Private  , hasDefaultValue =  false  )
    
        private QualificationRequest2ResSequenceType  value;        
        ...
        public void setValue(QualificationRequest2ResSequenceType value) {
            this.value = value;
        }
        
        
        
        public QualificationRequest2ResSequenceType getValue() {
            return this.value;
        }            
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(QualificationRequest2Res.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
