...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1BoxedType ( name = "OCalledPartyBusy" )
    public class OCalledPartyBusy implements IASN1PreparedElement {
                
        

       @ASN1PreparedElement
       @ASN1Sequence ( name = "OCalledPartyBusy" , isSet = true )
       public static class OCalledPartyBusySequenceType implements IASN1PreparedElement {
	...
	private ServingCellID servingCellID = null;
        ...
        public IASN1PreparedElementData getPreparedData() {
            return preparedData_OCalledPartyBusySequenceType;
        }

       private static IASN1PreparedElementData preparedData_OCalledPartyBusySequenceType = CoderFactory.getInstance().newPreparedElementData(OCalledPartyBusySequenceType.class);
                
       }

       
                
        @ASN1Element ( name = "OCalledPartyBusy", isOptional =  false , hasTag =  true, tag = 18, 
        tagClass =  TagClass.Private  , hasDefaultValue =  false  )
    
        private OCalledPartyBusySequenceType  value;        

        
        
        public OCalledPartyBusy () {
        }
        
        
        
        public void setValue(OCalledPartyBusySequenceType value) {
            this.value = value;
        }
        
        
        
        public OCalledPartyBusySequenceType getValue() {
            return this.value;
        }            
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(OCalledPartyBusy.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
