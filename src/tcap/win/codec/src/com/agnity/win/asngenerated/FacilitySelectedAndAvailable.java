...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1BoxedType ( name = "FacilitySelectedAndAvailable" )
    public class FacilitySelectedAndAvailable implements IASN1PreparedElement {
                
        

       @ASN1PreparedElement
       @ASN1Sequence ( name = "FacilitySelectedAndAvailable" , isSet = true )
	...
	private TerminationAccessType terminationAccessType = null;
       ...
       private static IASN1PreparedElementData preparedData_FacilitySelectedAndAvailableSequenceType = CoderFactory.getInstance().newPreparedElementData(FacilitySelectedAndAvailableSequenceType.class);
        ...
        @ASN1Element ( name = "FacilitySelectedAndAvailable", isOptional =  false , hasTag =  true, tag = 18, 
        tagClass =  TagClass.Private  , hasDefaultValue =  false  )
    
        private FacilitySelectedAndAvailableSequenceType  value;        
        ...
        public void setValue(FacilitySelectedAndAvailableSequenceType value) {
            this.value = value;
        }
        
        
        
        public FacilitySelectedAndAvailableSequenceType getValue() {
            return this.value;
        }            
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(FacilitySelectedAndAvailable.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
