...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1BoxedType ( name = "QualificationDirective" )
    public class QualificationDirective implements IASN1PreparedElement {
                
        

       @ASN1PreparedElement
       @ASN1Sequence ( name = "QualificationDirective" , isSet = true )
       public static class QualificationDirectiveSequenceType implements IASN1PreparedElement {
	...
	private SenderIdentificationNumber senderIdentificationNumber = null;
        ...
        public IASN1PreparedElementData getPreparedData() {
            return preparedData_QualificationDirectiveSequenceType;
        }

       private static IASN1PreparedElementData preparedData_QualificationDirectiveSequenceType = CoderFactory.getInstance().newPreparedElementData(QualificationDirectiveSequenceType.class);
                
       }

       
                
        @ASN1Element ( name = "QualificationDirective", isOptional =  false , hasTag =  true, tag = 18, 
        tagClass =  TagClass.Private  , hasDefaultValue =  false  )
    
        private QualificationDirectiveSequenceType  value;        

        
        
        public QualificationDirective () {
        }
        
        
        
        public void setValue(QualificationDirectiveSequenceType value) {
            this.value = value;
        }
        
        
        
        public QualificationDirectiveSequenceType getValue() {
            return this.value;
        }            
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(QualificationDirective.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
