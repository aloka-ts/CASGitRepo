...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1BoxedType ( name = "HandoffBack2Res" )
    public class HandoffBack2Res implements IASN1PreparedElement {
                
        

       @ASN1PreparedElement
       @ASN1Sequence ( name = "HandoffBack2Res" , isSet = true )
       public static class HandoffBack2ResSequenceType implements IASN1PreparedElement {
	...
	private TDMAVoiceCoder tdmaVoiceCoder = null;
        ...
        public IASN1PreparedElementData getPreparedData() {
            return preparedData_HandoffBack2ResSequenceType;
        }

       private static IASN1PreparedElementData preparedData_HandoffBack2ResSequenceType = CoderFactory.getInstance().newPreparedElementData(HandoffBack2ResSequenceType.class);
                
       }

       
                
        @ASN1Element ( name = "HandoffBack2Res", isOptional =  false , hasTag =  true, tag = 18, 
        tagClass =  TagClass.Private  , hasDefaultValue =  false  )
    
        private HandoffBack2ResSequenceType  value;        

        
        
        public HandoffBack2Res () {
        }
        
        
        
        public void setValue(HandoffBack2ResSequenceType value) {
            this.value = value;
        }
        
        
        
        public HandoffBack2ResSequenceType getValue() {
            return this.value;
        }            
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(HandoffBack2Res.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
