...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1BoxedType ( name = "TBusyRes" )
    public class TBusyRes implements IASN1PreparedElement {
                
        

       @ASN1PreparedElement
       @ASN1Sequence ( name = "TBusyRes" , isSet = true )
       public static class TBusyResSequenceType implements IASN1PreparedElement {
	...
	private TriggerAddressList triggerAddressList = null;
        ...
        public IASN1PreparedElementData getPreparedData() {
            return preparedData_TBusyResSequenceType;
        }

       private static IASN1PreparedElementData preparedData_TBusyResSequenceType = CoderFactory.getInstance().newPreparedElementData(TBusyResSequenceType.class);
                
       }

       
                
        @ASN1Element ( name = "TBusyRes", isOptional =  false , hasTag =  true, tag = 18, 
        tagClass =  TagClass.Private  , hasDefaultValue =  false  )
    
        private TBusyResSequenceType  value;        
        ...
        public void setValue(TBusyResSequenceType value) {
            this.value = value;
        }
        
        
        
        public TBusyResSequenceType getValue() {
            return this.value;
        }            
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(TBusyRes.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
