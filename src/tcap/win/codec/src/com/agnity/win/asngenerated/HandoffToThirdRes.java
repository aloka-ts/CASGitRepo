...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1BoxedType ( name = "HandoffToThirdRes" )
    public class HandoffToThirdRes implements IASN1PreparedElement {
                
        

       @ASN1PreparedElement
       @ASN1Sequence ( name = "HandoffToThirdRes" , isSet = true )
       public static class HandoffToThirdResSequenceType implements IASN1PreparedElement {
	...
	private TDMAVoiceCoder tdmaVoiceCoder = null;
        ...
        public IASN1PreparedElementData getPreparedData() {
            return preparedData_HandoffToThirdResSequenceType;
        }

       private static IASN1PreparedElementData preparedData_HandoffToThirdResSequenceType = CoderFactory.getInstance().newPreparedElementData(HandoffToThirdResSequenceType.class);
                
       }

       
                
        @ASN1Element ( name = "HandoffToThirdRes", isOptional =  false , hasTag =  true, tag = 18, 
        tagClass =  TagClass.Private  , hasDefaultValue =  false  )
    
        private HandoffToThirdResSequenceType  value;        
        ...
        public void setValue(HandoffToThirdResSequenceType value) {
            this.value = value;
        }
        
        
        
        public HandoffToThirdResSequenceType getValue() {
            return this.value;
        }            
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(HandoffToThirdRes.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
