...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1BoxedType ( name = "OCalledPartyBusyRes" )
    public class OCalledPartyBusyRes implements IASN1PreparedElement {
                
        

       @ASN1PreparedElement
       @ASN1Sequence ( name = "OCalledPartyBusyRes" , isSet = true )
       public static class OCalledPartyBusyResSequenceType implements IASN1PreparedElement {
	...
	private TriggerAddressList triggerAddressList = null;
        ...
        public IASN1PreparedElementData getPreparedData() {
            return preparedData_OCalledPartyBusyResSequenceType;
        }

       private static IASN1PreparedElementData preparedData_OCalledPartyBusyResSequenceType = CoderFactory.getInstance().newPreparedElementData(OCalledPartyBusyResSequenceType.class);
                
       }

       
                
        @ASN1Element ( name = "OCalledPartyBusyRes", isOptional =  false , hasTag =  true, tag = 18, 
        tagClass =  TagClass.Private  , hasDefaultValue =  false  )
    
        private OCalledPartyBusyResSequenceType  value;        

        
        
        public OCalledPartyBusyRes () {
        }
        
        
        
        public void setValue(OCalledPartyBusyResSequenceType value) {
            this.value = value;
        }
        
        
        
        public OCalledPartyBusyResSequenceType getValue() {
            return this.value;
        }            
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(OCalledPartyBusyRes.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
