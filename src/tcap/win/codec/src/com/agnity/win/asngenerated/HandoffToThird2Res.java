...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1BoxedType ( name = "HandoffToThird2Res" )
    public class HandoffToThird2Res implements IASN1PreparedElement {
                
        

       @ASN1PreparedElement
       @ASN1Sequence ( name = "HandoffToThird2Res" , isSet = true )
       public static class HandoffToThird2ResSequenceType implements IASN1PreparedElement {
	...
	private TDMAVoiceCoder tdmaVoiceCoder = null;
        ...
        public IASN1PreparedElementData getPreparedData() {
            return preparedData_HandoffToThird2ResSequenceType;
        }

       private static IASN1PreparedElementData preparedData_HandoffToThird2ResSequenceType = CoderFactory.getInstance().newPreparedElementData(HandoffToThird2ResSequenceType.class);
                
       }

       
                
        @ASN1Element ( name = "HandoffToThird2Res", isOptional =  false , hasTag =  true, tag = 18, 
        tagClass =  TagClass.Private  , hasDefaultValue =  false  )
    
        private HandoffToThird2ResSequenceType  value;        

        
        
        public HandoffToThird2Res () {
        }
        
        
        
        public void setValue(HandoffToThird2ResSequenceType value) {
            this.value = value;
        }
        
        
        
        public HandoffToThird2ResSequenceType getValue() {
            return this.value;
        }            
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(HandoffToThird2Res.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
