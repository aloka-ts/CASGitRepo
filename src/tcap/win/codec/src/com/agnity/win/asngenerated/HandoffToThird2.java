...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1BoxedType ( name = "HandoffToThird2" )
    public class HandoffToThird2 implements IASN1PreparedElement {
                
        

       @ASN1PreparedElement
       @ASN1Sequence ( name = "HandoffToThird2" , isSet = true )
       public static class HandoffToThird2SequenceType implements IASN1PreparedElement {
	...
	private MEID meid = null;
        ...
        public IASN1PreparedElementData getPreparedData() {
            return preparedData_HandoffToThird2SequenceType;
        }

       private static IASN1PreparedElementData preparedData_HandoffToThird2SequenceType = CoderFactory.getInstance().newPreparedElementData(HandoffToThird2SequenceType.class);
                
       }

       
                
        @ASN1Element ( name = "HandoffToThird2", isOptional =  false , hasTag =  true, tag = 18, 
        tagClass =  TagClass.Private  , hasDefaultValue =  false  )
    
        private HandoffToThird2SequenceType  value;        

        
        
        public HandoffToThird2 () {
        }
        
        
        
        public void setValue(HandoffToThird2SequenceType value) {
            this.value = value;
        }
        
        
        
        public HandoffToThird2SequenceType getValue() {
            return this.value;
        }            
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(HandoffToThird2.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
