...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "PSTNTermination", isSet = false )
    public class PSTNTermination implements IASN1PreparedElement {
	...
	private TerminationTriggers terminationTriggers = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(PSTNTermination.class);
