...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1BoxedType ( name = "ServiceRequestRes" )
    public class ServiceRequestRes implements IASN1PreparedElement {
                
        

       @ASN1PreparedElement
       @ASN1Sequence ( name = "ServiceRequestRes" , isSet = true )
       public static class ServiceRequestResSequenceType implements IASN1PreparedElement {
	...
	private TriggerAddressList triggerAddressList = null;
        ...
        public IASN1PreparedElementData getPreparedData() {
            return preparedData_ServiceRequestResSequenceType;
        }

       private static IASN1PreparedElementData preparedData_ServiceRequestResSequenceType = CoderFactory.getInstance().newPreparedElementData(ServiceRequestResSequenceType.class);
                
       }

       
                
        @ASN1Element ( name = "ServiceRequestRes", isOptional =  false , hasTag =  true, tag = 18, 
        tagClass =  TagClass.Private  , hasDefaultValue =  false  )
    
        private ServiceRequestResSequenceType  value;        
        ...
        public void setValue(ServiceRequestResSequenceType value) {
            this.value = value;
        }
        
        
        
        public ServiceRequestResSequenceType getValue() {
            return this.value;
        }            
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(ServiceRequestRes.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
