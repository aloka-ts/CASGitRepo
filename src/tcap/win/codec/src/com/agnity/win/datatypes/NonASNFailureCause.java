...
import com.agnity.win.enumdata.CauseValEnum;
import com.agnity.win.enumdata.CodingStndEnum;
import com.agnity.win.enumdata.LocationEnum;
import com.agnity.win.exceptions.InvalidInputException;
import com.agnity.win.util.Util;

/**
 * Used for encoding and decoding of NonASNFailureCause
 * @author Supriya Jain
 *
 */

public class NonASNFailureCause {
	...
	private static Logger logger = Logger.getLogger(NonASNFailureCause.class);	 
	...
	/**
	 * This function will encode NonASNFailureCause. causeValEnum is mandatory parameter.
	...
	public static byte[] encodeCauseVal(LocationEnum locationEnum, CodingStndEnum codingStndEnum , CauseValEnum causeValEnum) throws InvalidInputException{
		...
		logger.debug("encodeCauseVal:Encoded NonASNFailureCause: "+ Util.formatBytes(myParms));
	...
	/**
	 * This function will decode NonASNFailureCause.
	 * @param data
	 * @return object of CauseDataType
	 * @throws InvalidInputException
	 */
	public static NonASNFailureCause decodeCauseVal(byte[] data) throws InvalidInputException{
		logger.info("decodeCauseVal:Enter");
		if(logger.isDebugEnabled())
		logger.debug("decodeCauseVal: Input--> data:" + Util.formatBytes(data));
		if(data == null){
			logger.error("decodeCauseVal: InvalidInputException(Input data(bytes) not present or null)");
			throw new InvalidInputException("Input data(bytes) not present or null");
		}
		NonASNFailureCause causeData = new NonASNFailureCause();
