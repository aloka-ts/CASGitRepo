...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1BoxedType ( name = "OAnswer" )
    public class OAnswer implements IASN1PreparedElement {
                
        

       @ASN1PreparedElement
       @ASN1Sequence ( name = "OAnswer" , isSet = true )
       public static class OAnswerSequenceType implements IASN1PreparedElement {
	...
	private SystemMyTypeCode systemMyTypeCode = null;
        ...
        public IASN1PreparedElementData getPreparedData() {
            return preparedData_OAnswerSequenceType;
        }

       private static IASN1PreparedElementData preparedData_OAnswerSequenceType = CoderFactory.getInstance().newPreparedElementData(OAnswerSequenceType.class);
                
       }

       
                
        @ASN1Element ( name = "OAnswer", isOptional =  false , hasTag =  true, tag = 18, 
        tagClass =  TagClass.Private  , hasDefaultValue =  false  )
    
        private OAnswerSequenceType  value;        
        ...
        public void setValue(OAnswerSequenceType value) {
            this.value = value;
        }
        
        
        
        public OAnswerSequenceType getValue() {
            return this.value;
        }            
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(OAnswer.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
