...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1BoxedType ( name = "OriginationRequestRes" )
    public class OriginationRequestRes implements IASN1PreparedElement {
                
        

       @ASN1PreparedElement
       @ASN1Sequence ( name = "OriginationRequestRes" , isSet = true )
       public static class OriginationRequestResSequenceType implements IASN1PreparedElement {
	...
	private TriggerAddressList triggerAddressList = null;
        ...
        public IASN1PreparedElementData getPreparedData() {
            return preparedData_OriginationRequestResSequenceType;
        }

       private static IASN1PreparedElementData preparedData_OriginationRequestResSequenceType = CoderFactory.getInstance().newPreparedElementData(OriginationRequestResSequenceType.class);
                
       }

       
                
        @ASN1Element ( name = "OriginationRequestRes", isOptional =  false , hasTag =  true, tag = 18, 
        tagClass =  TagClass.Private  , hasDefaultValue =  false  )
    
        private OriginationRequestResSequenceType  value;        

        
        
        public OriginationRequestRes () {
        }
        
        
        
        public void setValue(OriginationRequestResSequenceType value) {
            this.value = value;
        }
        
        
        
        public OriginationRequestResSequenceType getValue() {
            return this.value;
        }            
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(OriginationRequestRes.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
