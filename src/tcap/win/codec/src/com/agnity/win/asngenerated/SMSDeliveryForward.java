...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1BoxedType ( name = "SMSDeliveryForward" )
    public class SMSDeliveryForward implements IASN1PreparedElement {
                
        

       @ASN1PreparedElement
       @ASN1Sequence ( name = "SMSDeliveryForward" , isSet = true )
       public static class SMSDeliveryForwardSequenceType implements IASN1PreparedElement {
	...
	private SMS_OriginatingAddress sms_OriginatingAddress = null;
        ...
        public IASN1PreparedElementData getPreparedData() {
            return preparedData_SMSDeliveryForwardSequenceType;
        }

       private static IASN1PreparedElementData preparedData_SMSDeliveryForwardSequenceType = CoderFactory.getInstance().newPreparedElementData(SMSDeliveryForwardSequenceType.class);
                
       }

       
                
        @ASN1Element ( name = "SMSDeliveryForward", isOptional =  false , hasTag =  true, tag = 18, 
        tagClass =  TagClass.Private  , hasDefaultValue =  false  )
    
        private SMSDeliveryForwardSequenceType  value;        

        
        
        public SMSDeliveryForward () {
        }
        
        
        
        public void setValue(SMSDeliveryForwardSequenceType value) {
            this.value = value;
        }
        
        
        
        public SMSDeliveryForwardSequenceType getValue() {
            return this.value;
        }            
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(SMSDeliveryForward.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
