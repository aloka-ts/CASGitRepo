...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1BoxedType ( name = "HandoffToThird" )
    public class HandoffToThird implements IASN1PreparedElement {
                
        

       @ASN1PreparedElement
       @ASN1Sequence ( name = "HandoffToThird" , isSet = true )
       public static class HandoffToThirdSequenceType implements IASN1PreparedElement {
	...
	private VoicePrivacyMask voicePrivacyMask = null;
        ...
        public IASN1PreparedElementData getPreparedData() {
            return preparedData_HandoffToThirdSequenceType;
        }

       private static IASN1PreparedElementData preparedData_HandoffToThirdSequenceType = CoderFactory.getInstance().newPreparedElementData(HandoffToThirdSequenceType.class);
                
       }

       
                
        @ASN1Element ( name = "HandoffToThird", isOptional =  false , hasTag =  true, tag = 18, 
        tagClass =  TagClass.Private  , hasDefaultValue =  false  )
    
        private HandoffToThirdSequenceType  value;        
        ...
        public void setValue(HandoffToThirdSequenceType value) {
            this.value = value;
        }
        
        
        
        public HandoffToThirdSequenceType getValue() {
            return this.value;
        }            
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(HandoffToThird.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
