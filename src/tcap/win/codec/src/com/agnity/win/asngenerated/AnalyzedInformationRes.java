...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1BoxedType ( name = "AnalyzedInformationRes" )
    public class AnalyzedInformationRes implements IASN1PreparedElement {
                
        

       @ASN1PreparedElement
       @ASN1Sequence ( name = "AnalyzedInformationRes" , isSet = true )
       public static class AnalyzedInformationResSequenceType implements IASN1PreparedElement {
	...
	private TriggerAddressList triggerAddressList = null;
        ...
        public IASN1PreparedElementData getPreparedData() {
            return preparedData_AnalyzedInformationResSequenceType;
        }

       private static IASN1PreparedElementData preparedData_AnalyzedInformationResSequenceType = CoderFactory.getInstance().newPreparedElementData(AnalyzedInformationResSequenceType.class);
                
       }

       
                
        @ASN1Element ( name = "AnalyzedInformationRes", isOptional =  false , hasTag =  true, tag = 18, 
        tagClass =  TagClass.Private  , hasDefaultValue =  false  )
    
        private AnalyzedInformationResSequenceType  value;        

        
        
        public AnalyzedInformationRes () {
        }
        
        
        
        public void setValue(AnalyzedInformationResSequenceType value) {
            this.value = value;
        }
        
        
        
        public AnalyzedInformationResSequenceType getValue() {
            return this.value;
        }            
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(AnalyzedInformationRes.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
