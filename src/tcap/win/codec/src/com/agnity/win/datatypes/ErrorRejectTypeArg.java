...
/**
 * This class have parameters for error or reject operations. Type will be
 * identified by the enum.
 * 
 * @author Rajeev Arya
 * 
 */
public class ErrorRejectTypeArg {
	...
	public String toString() {
		return "errorRejectEnum:" + errorRejectEnum + " ,errorCode:"
				+ Util.formatBytes(errorCode) + " ,errorType:" + errorType
				+ " ,rejectProblem:" + rejectProblem + " ,rejectProblemType:"
				+ rejectProblemType;
	}
