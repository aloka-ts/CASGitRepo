...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1BoxedType ( name = "TAnswer" )
    public class TAnswer implements IASN1PreparedElement {
                
        

       @ASN1PreparedElement
       @ASN1Sequence ( name = "TAnswer" , isSet = true )
       public static class TAnswerSequenceType implements IASN1PreparedElement {
	...
	private TerminationAccessType terminationAccessType = null;
        ...
        public IASN1PreparedElementData getPreparedData() {
            return preparedData_TAnswerSequenceType;
        }

       private static IASN1PreparedElementData preparedData_TAnswerSequenceType = CoderFactory.getInstance().newPreparedElementData(TAnswerSequenceType.class);
                
       }

       
                
        @ASN1Element ( name = "TAnswer", isOptional =  false , hasTag =  true, tag = 18, 
        tagClass =  TagClass.Private  , hasDefaultValue =  false  )
    
        private TAnswerSequenceType  value;        
        ...
        public void setValue(TAnswerSequenceType value) {
            this.value = value;
        }
        
        
        
        public TAnswerSequenceType getValue() {
            return this.value;
        }            
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(TAnswer.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
