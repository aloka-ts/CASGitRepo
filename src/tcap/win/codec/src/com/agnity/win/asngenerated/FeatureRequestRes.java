...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1BoxedType ( name = "FeatureRequestRes" )
    public class FeatureRequestRes implements IASN1PreparedElement {
                
        

       @ASN1PreparedElement
       @ASN1Sequence ( name = "FeatureRequestRes" , isSet = true )
       public static class FeatureRequestResSequenceType implements IASN1PreparedElement {
                
        @ASN1Element ( name = "featureResult", isOptional =  false , hasTag =  true, tag = 18 , hasDefaultValue =  false  )
    
	private FeatureResult featureResult = null;
	...
	private TriggerAddressList triggerAddressList = null;
        ...
        public void setFeatureResult (FeatureResult value) {
            this.featureResult = value;
        }
        ...
        public IASN1PreparedElementData getPreparedData() {
            return preparedData_FeatureRequestResSequenceType;
        }

       private static IASN1PreparedElementData preparedData_FeatureRequestResSequenceType = CoderFactory.getInstance().newPreparedElementData(FeatureRequestResSequenceType.class);
                
       }

       
                
        @ASN1Element ( name = "FeatureRequestRes", isOptional =  false , hasTag =  true, tag = 18, 
        tagClass =  TagClass.Private  , hasDefaultValue =  false  )
    
        private FeatureRequestResSequenceType  value;        

        
        
        public FeatureRequestRes () {
        }
        
        
        
        public void setValue(FeatureRequestResSequenceType value) {
            this.value = value;
        }
        
        
        
        public FeatureRequestResSequenceType getValue() {
            return this.value;
        }            
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(FeatureRequestRes.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
