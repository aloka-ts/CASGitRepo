...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1BoxedType ( name = "TNoAnswer" )
    public class TNoAnswer implements IASN1PreparedElement {
                
        

       @ASN1PreparedElement
       @ASN1Sequence ( name = "TNoAnswer" , isSet = true )
       public static class TNoAnswerSequenceType implements IASN1PreparedElement {
	...
	private TerminationAccessType terminationAccessType = null;
        ...
        public IASN1PreparedElementData getPreparedData() {
            return preparedData_TNoAnswerSequenceType;
        }

       private static IASN1PreparedElementData preparedData_TNoAnswerSequenceType = CoderFactory.getInstance().newPreparedElementData(TNoAnswerSequenceType.class);
                
       }

       
                
        @ASN1Element ( name = "TNoAnswer", isOptional =  false , hasTag =  true, tag = 18, 
        tagClass =  TagClass.Private  , hasDefaultValue =  false  )
    
        private TNoAnswerSequenceType  value;        
        ...
        public void setValue(TNoAnswerSequenceType value) {
            this.value = value;
        }
        
        
        
        public TNoAnswerSequenceType getValue() {
            return this.value;
        }            
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(TNoAnswer.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
