...
public abstract class /*generated*/ RejectReqEventInterface
{
	private RejectReqEvent iRejectReqEventType = null;
	public RejectReqEvent getRejectReqEventInterface() throws TcapContentReaderException
	{
		try
		{
			if (iRejectReqEventType == null)
			{
				iRejectReqEventType = new RejectReqEvent(this);
				if (getParameters() != null)
					iRejectReqEventType.setParameters(getParameters().getParametersInterface());
				if (getLinkId() != null)
					iRejectReqEventType.setLinkId(getLinkId().intValue());
				iRejectReqEventType.setProblemType(getIntProblemType());
				iRejectReqEventType.setProblem(getIntProblem());
				if (getRejectType() != null)
					iRejectReqEventType.setRejectType(getIntRejectType());
				if (getDialogueId() != null)
					iRejectReqEventType.setDialogueId(getDialogueId().intValue());
				if (getInvokeId() != null)
					iRejectReqEventType.setInvokeId(getInvokeId().intValue());
			}
			return iRejectReqEventType;
		}
		catch (Exception e)
		{
	...
	static public RejectReqEventType produceJAXB(RejectReqEvent iRejectReqEvent) throws TcapContentWriterException
	{
		try
		{
			RejectReqEventType iRejectReqEventType = new RejectReqEventType();
			if (iRejectReqEvent.isParametersPresent())
				iRejectReqEventType.setParameters(ParametersType.produceJAXB(iRejectReqEvent.getParameters()));
			if (iRejectReqEvent.isLinkIdPresent())
				iRejectReqEventType.setLinkId(BigInteger.valueOf(iRejectReqEvent.getLinkId()));
			iRejectReqEventType.setProblemType(getStringProblemType(iRejectReqEvent.getProblemType()));
			iRejectReqEventType.setProblem(getStringProblem(iRejectReqEvent.getProblem()));
			if (iRejectReqEvent.isRejectTypePresent())
				iRejectReqEventType.setRejectType(getStringRejectType(iRejectReqEvent.getRejectType()));
			if (iRejectReqEvent.isDialogueIdPresent())
				iRejectReqEventType.setDialogueId(BigInteger.valueOf(iRejectReqEvent.getDialogueId()));
			if (iRejectReqEvent.isInvokeIdPresent())
				iRejectReqEventType.setInvokeId(BigInteger.valueOf(iRejectReqEvent.getInvokeId()));
			return iRejectReqEventType;
		}
		catch (Exception e)
		{
