...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "AnalyseInformationArg", isSet = false )
    public class AnalyseInformationArg implements IASN1PreparedElement {
	...
	private ISDNAccessRelatedInformation iSDNAccessRelatedInformation = null;
        ...
        @ASN1Element ( name = "originalCalledPartyID", isOptional =  true , hasTag =  true, tag = 3 , hasDefaultValue =  false  )
...
@ASN1SequenceOf( name = "extensions", isSetOf = false ) 
	...
	private CallingPartyNumber callingPartyNumber = null;
        ...
        @ASN1Element ( name = "callingPartysCategory", isOptional =  true , hasTag =  true, tag = 6 , hasDefaultValue =  false  )
    
	private CallingPartysCategory callingPartysCategory = null;
                
  
        @ASN1Element ( name = "calledPartyNumber", isOptional =  true , hasTag =  true, tag = 7 , hasDefaultValue =  false  )
    
	private CalledPartyNumber calledPartyNumber = null;
                
  
        @ASN1Element ( name = "chargeNumber", isOptional =  true , hasTag =  true, tag = 8 , hasDefaultValue =  false  )
	...
	private TravellingClassMark travellingClassMark = null;
        ...
        @ASN1Element ( name = "carrier", isOptional =  true , hasTag =  true, tag = 10 , hasDefaultValue =  false  )
    
	private Carrier carrier = null;
                
  
        @ASN1Element ( name = "serviceInteractionIndicators", isOptional =  true , hasTag =  true, tag = 11 , hasDefaultValue =  false  )
    
	private ServiceInteractionIndicators serviceInteractionIndicators = null;
                
  
        @ASN1Element ( name = "iNServiceCompatibilityResponse", isOptional =  true , hasTag =  true, tag = 12 , hasDefaultValue =  false  )
    
	private INServiceCompatibilityResponse iNServiceCompatibilityResponse = null;
                
  
        @ASN1Element ( name = "forwardGVNS", isOptional =  true , hasTag =  true, tag = 13 , hasDefaultValue =  false  )
    
	private ForwardGVNS forwardGVNS = null;
                
  
        @ASN1Element ( name = "backwardGVNS", isOptional =  true , hasTag =  true, tag = 14 , hasDefaultValue =  false  )
	...
	private ServiceInteractionIndicatorsTwo serviceInteractionIndicatorsTwo = null;
        ...
        @ASN1Element ( name = "correlationID", isOptional =  true , hasTag =  true, tag = 16 , hasDefaultValue =  false  )
    
	private CorrelationID correlationID = null;
                
  
        @ASN1Element ( name = "scfID", isOptional =  true , hasTag =  true, tag = 17 , hasDefaultValue =  false  )
    
	private ScfID scfID = null;
                
  
        @ASN1Element ( name = "callSegmentID", isOptional =  true , hasTag =  true, tag = 18 , hasDefaultValue =  false  )
    
	private CallSegmentID callSegmentID = null;
                
  
        @ASN1Element ( name = "legToBeCreated", isOptional =  true , hasTag =  true, tag = 19 , hasDefaultValue =  false  )
	...
	private LegID legToBeCreated = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(AnalyseInformationArg.class);
