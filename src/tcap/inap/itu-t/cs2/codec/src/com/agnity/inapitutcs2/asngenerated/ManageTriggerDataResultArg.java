...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "ManageTriggerDataResultArg", isSet = false )
    public class ManageTriggerDataResultArg implements IASN1PreparedElement {
            
        @ASN1Element ( name = "actionPerformed", isOptional =  false , hasTag =  true, tag = 0 , hasDefaultValue =  false  )
...
@ASN1SequenceOf( name = "extensions", isSetOf = false ) 
	...
	private java.util.Collection<ExtensionField>  extensions = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(ManageTriggerDataResultArg.class);
