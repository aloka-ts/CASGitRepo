...
import org.bn.types.*;
	...
	private GapOnService gapOnService = null;
        ...
        @ASN1Null ( name = "gapAllInTraffic" ) 
    
        @ASN1Element ( name = "gapAllInTraffic", isOptional =  false , hasTag =  true, tag = 3 , hasDefaultValue =  false  )
    
	private org.bn.types.NullObject gapAllInTraffic = null;
	...
	private CallingAddressAndServiceSequenceType callingAddressAndService = null;
        ...
        public org.bn.types.NullObject getGapAllInTraffic () {
            return this.gapAllInTraffic;
        }

        public boolean isGapAllInTrafficSelected () {
            return this.gapAllInTraffic != null;
        }

        private void setGapAllInTraffic (org.bn.types.NullObject value) {
            this.gapAllInTraffic = value;
        }

        
        public void selectGapAllInTraffic () {
            selectGapAllInTraffic (new org.bn.types.NullObject());
	}
	
        public void selectGapAllInTraffic (org.bn.types.NullObject value) {
            this.gapAllInTraffic = value;
