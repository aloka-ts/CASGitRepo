...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "AnalysedInformationArg", isSet = false )
    public class AnalysedInformationArg implements IASN1PreparedElement {
	...
	private RedirectionInformation redirectionInformation = null;
        ...
        @ASN1Element ( name = "routeList", isOptional =  true , hasTag =  true, tag = 10 , hasDefaultValue =  false  )
    
	private RouteList routeList = null;
                
  
        @ASN1Element ( name = "travellingClassMark", isOptional =  true , hasTag =  true, tag = 11 , hasDefaultValue =  false  )
...
@ASN1SequenceOf( name = "extensions", isSetOf = false ) 
	...
	private java.util.Collection<ExtensionField>  extensions = null;
        ...
        @ASN1Element ( name = "featureCode", isOptional =  true , hasTag =  true, tag = 13 , hasDefaultValue =  false  )
    
	private FeatureCode featureCode = null;
                
  
        @ASN1Element ( name = "accessCode", isOptional =  true , hasTag =  true, tag = 14 , hasDefaultValue =  false  )
    
	private AccessCode accessCode = null;
                
  
        @ASN1Element ( name = "carrier", isOptional =  true , hasTag =  true, tag = 15 , hasDefaultValue =  false  )
    
	private Carrier carrier = null;
                
  
        @ASN1Element ( name = "componentType", isOptional =  true , hasTag =  true, tag = 16 , hasDefaultValue =  false  )
    
	private ComponentType componentType = null;
                
  
        @ASN1Element ( name = "component", isOptional =  true , hasTag =  true, tag = 17 , hasDefaultValue =  false  )
    
	private Component component = null;
                
  
        @ASN1Element ( name = "componentCorrelationID", isOptional =  true , hasTag =  true, tag = 18 , hasDefaultValue =  false  )
	...
	private ComponentCorrelationID componentCorrelationID = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(AnalysedInformationArg.class);
