...
import org.bn.types.*;
  ...
  @ASN1OctetString( name = "" )
        ...
        @ASN1Element ( name = "callOfferingTreatmentIndicator", isOptional =  true , hasTag =  true, tag = 3 , hasDefaultValue =  false  )
    
	private byte[] callOfferingTreatmentIndicator = null;
        ...
        public byte[] getCallOfferingTreatmentIndicator () {
            return this.callOfferingTreatmentIndicator;
        }

        
        public boolean isCallOfferingTreatmentIndicatorPresent () {
            return this.callOfferingTreatmentIndicator != null;
        }
        

        public void setCallOfferingTreatmentIndicator (byte[] value) {
            this.callOfferingTreatmentIndicator = value;
        }
