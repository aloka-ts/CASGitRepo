...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "OCalledPartyBusyArg", isSet = false )
    public class OCalledPartyBusyArg implements IASN1PreparedElement {
...
@ASN1SequenceOf( name = "extensions", isSetOf = false ) 
	...
	private java.util.Collection<ExtensionField>  extensions = null;
        ...
        @ASN1Element ( name = "carrier", isOptional =  true , hasTag =  true, tag = 13 , hasDefaultValue =  false  )
	...
	private Carrier carrier = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(OCalledPartyBusyArg.class);
