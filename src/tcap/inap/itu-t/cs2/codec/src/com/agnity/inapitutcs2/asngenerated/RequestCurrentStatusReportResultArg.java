...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "RequestCurrentStatusReportResultArg", isSet = false )
    public class RequestCurrentStatusReportResultArg implements IASN1PreparedElement {
            
        @ASN1Element ( name = "resourceStatus", isOptional =  false , hasTag =  true, tag = 0 , hasDefaultValue =  false  )
    
	private ResourceStatus resourceStatus = null;
                
  
        @ASN1Element ( name = "resourceID", isOptional =  true , hasTag =  true, tag = 1 , hasDefaultValue =  false  )
...
@ASN1SequenceOf( name = "extensions", isSetOf = false ) 
	...
	private java.util.Collection<ExtensionField>  extensions = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(RequestCurrentStatusReportResultArg.class);
