...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "RequestEveryStatusChangeReportArg", isSet = false )
    public class RequestEveryStatusChangeReportArg implements IASN1PreparedElement {
            
        @ASN1Element ( name = "resourceID", isOptional =  false , hasTag =  true, tag = 0 , hasDefaultValue =  false  )
	...
	private CorrelationID correlationID = null;
        ...
        @ASN1Element ( name = "monitorDuration", isOptional =  true , hasTag =  true, tag = 2 , hasDefaultValue =  false  )
...
@ASN1SequenceOf( name = "extensions", isSetOf = false ) 
	...
	private java.util.Collection<ExtensionField>  extensions = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(RequestEveryStatusChangeReportArg.class);
