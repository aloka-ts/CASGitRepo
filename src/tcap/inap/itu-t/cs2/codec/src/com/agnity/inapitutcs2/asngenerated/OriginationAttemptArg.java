...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "OriginationAttemptArg", isSet = false )
    public class OriginationAttemptArg implements IASN1PreparedElement {
...
@ASN1SequenceOf( name = "extensions", isSetOf = false ) 
	...
	private Component component = null;
        ...
        @ASN1Element ( name = "componenttCorrelationID", isOptional =  true , hasTag =  true, tag = 10 , hasDefaultValue =  false  )
    
	private ComponentCorrelationID componenttCorrelationID = null;
        ...
        public ComponentCorrelationID getComponenttCorrelationID () {
            return this.componenttCorrelationID;
        }

        
        public boolean isComponenttCorrelationIDPresent () {
            return this.componenttCorrelationID != null;
        }
        

        public void setComponenttCorrelationID (ComponentCorrelationID value) {
            this.componenttCorrelationID = value;
        }
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(OriginationAttemptArg.class);
