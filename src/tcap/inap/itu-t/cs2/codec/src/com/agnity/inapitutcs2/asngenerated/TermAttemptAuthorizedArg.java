...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "TermAttemptAuthorizedArg", isSet = false )
    public class TermAttemptAuthorizedArg implements IASN1PreparedElement {
...
@ASN1SequenceOf( name = "extensions", isSetOf = false ) 
	...
	private java.util.Collection<ExtensionField>  extensions = null;
        ...
        @ASN1Element ( name = "callingPartySubaddress", isOptional =  true , hasTag =  true, tag = 10 , hasDefaultValue =  false  )
	...
	private CallingPartySubaddress callingPartySubaddress = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(TermAttemptAuthorizedArg.class);
