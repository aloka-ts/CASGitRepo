...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "OAnswerArg", isSet = false )
    public class OAnswerArg implements IASN1PreparedElement {
...
@ASN1SequenceOf( name = "extensions", isSetOf = false ) 
	...
	private java.util.Collection<ExtensionField>  extensions = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(OAnswerArg.class);
