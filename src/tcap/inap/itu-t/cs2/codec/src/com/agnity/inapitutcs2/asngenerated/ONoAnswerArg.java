...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "ONoAnswerArg", isSet = false )
    public class ONoAnswerArg implements IASN1PreparedElement {
	...
	private OriginalCalledPartyID originalCalledPartyID = null;
        ...
        @ASN1Element ( name = "prefix", isOptional =  true , hasTag =  true, tag = 6 , hasDefaultValue =  false  )
    
	private Digits prefix = null;
                
  
        @ASN1Element ( name = "redirectingPartyID", isOptional =  true , hasTag =  true, tag = 7 , hasDefaultValue =  false  )
    
	private RedirectingPartyID redirectingPartyID = null;
                
  
        @ASN1Element ( name = "redirectionInformation", isOptional =  true , hasTag =  true, tag = 8 , hasDefaultValue =  false  )
    
	private RedirectionInformation redirectionInformation = null;
                
  
        @ASN1Element ( name = "routeList", isOptional =  true , hasTag =  true, tag = 9 , hasDefaultValue =  false  )
...
@ASN1SequenceOf( name = "extensions", isSetOf = false ) 
	...
	private java.util.Collection<ExtensionField>  extensions = null;
        ...
        @ASN1Element ( name = "carrier", isOptional =  true , hasTag =  true, tag = 12 , hasDefaultValue =  false  )
	...
	private Carrier carrier = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(ONoAnswerArg.class);
