...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "TNoAnswerArg", isSet = false )
    public class TNoAnswerArg implements IASN1PreparedElement {
...
@ASN1SequenceOf( name = "extensions", isSetOf = false ) 
	...
	private ComponentCorrelationID componentCorrelationID = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(TNoAnswerArg.class);
