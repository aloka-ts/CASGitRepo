...
import org.bn.types.*;
	...
	private ServiceKey serviceKey = null;
        ...
        @ASN1Element ( name = "dpCriteria", isOptional =  true , hasTag =  true, tag = 1 , hasDefaultValue =  false  )
    
	private EventTypeBCSM dpCriteria = null;
        ...
        public EventTypeBCSM getDpCriteria () {
            return this.dpCriteria;
        }

        
        public boolean isDpCriteriaPresent () {
            return this.dpCriteria != null;
        }
        

        public void setDpCriteria (EventTypeBCSM value) {
            this.dpCriteria = value;
        }
