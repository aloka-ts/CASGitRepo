...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "SelectRouteArg", isSet = false )
    public class SelectRouteArg implements IASN1PreparedElement {
	...
	private CorrelationID correlationID = null;
        ...
        @ASN1Element ( name = "iSDNAccessRelatedInformation", isOptional =  true , hasTag =  true, tag = 3 , hasDefaultValue =  false  )
	...
	private OriginalCalledPartyID originalCalledPartyID = null;
        ...
        @ASN1Element ( name = "routeList", isOptional =  true , hasTag =  true, tag = 5 , hasDefaultValue =  false  )
    
	private RouteList routeList = null;
                
  
        @ASN1Element ( name = "scfID", isOptional =  true , hasTag =  true, tag = 6 , hasDefaultValue =  false  )
    
	private ScfID scfID = null;
                
  
        @ASN1Element ( name = "travellingClassMark", isOptional =  true , hasTag =  true, tag = 7 , hasDefaultValue =  false  )
...
@ASN1SequenceOf( name = "extensions", isSetOf = false ) 
    ...
    @ASN1ValueRangeConstraint ( 
        ...
        @ASN1Element ( name = "extensions", isOptional =  true , hasTag =  true, tag = 8 , hasDefaultValue =  false  )
    
	private java.util.Collection<ExtensionField>  extensions = null;
                
  
        @ASN1Element ( name = "carrier", isOptional =  true , hasTag =  true, tag = 9 , hasDefaultValue =  false  )
    
	private Carrier carrier = null;
                
  
        @ASN1Element ( name = "serviceInteractionIndicators", isOptional =  true , hasTag =  true, tag = 10 , hasDefaultValue =  false  )
    
	private ServiceInteractionIndicators serviceInteractionIndicators = null;
                
  
        @ASN1Element ( name = "iNServiceCompatibilityResponse", isOptional =  true , hasTag =  true, tag = 11 , hasDefaultValue =  false  )
    
	private INServiceCompatibilityResponse iNServiceCompatibilityResponse = null;
                
  
        @ASN1Element ( name = "forwardGVNS", isOptional =  true , hasTag =  true, tag = 12 , hasDefaultValue =  false  )
    
	private ForwardGVNS forwardGVNS = null;
                
  
        @ASN1Element ( name = "backwardGVNS", isOptional =  true , hasTag =  true, tag = 13 , hasDefaultValue =  false  )
    
	private BackwardGVNS backwardGVNS = null;
                
  
        @ASN1Element ( name = "serviceInteractionIndicatorsTwo", isOptional =  true , hasTag =  true, tag = 14 , hasDefaultValue =  false  )
	...
	private LegID legToBeCreated = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(SelectRouteArg.class);
