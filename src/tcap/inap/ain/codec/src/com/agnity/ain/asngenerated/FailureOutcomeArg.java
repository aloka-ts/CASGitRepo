...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "FailureOutcomeArg", isSet = false )
    public class FailureOutcomeArg implements IASN1PreparedElement {
	...
	private ExtensionParameter extensionParameter = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(FailureOutcomeArg.class);
