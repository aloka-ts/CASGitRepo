...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "TDTMFEnteredArg", isSet = false )
    public class TDTMFEnteredArg implements IASN1PreparedElement {
	...
	private BearerCapability bearerCapability = null;
        ...
        @ASN1Element ( name = "dTMFDigitsDetected", isOptional =  true , hasTag =  false  , hasDefaultValue =  false  )
    
	private DTMFDigitsDetected dTMFDigitsDetected = null;
	...
	private NotificationIndicator notificationIndicator = null;
        ...
        public DTMFDigitsDetected getDTMFDigitsDetected () {
            return this.dTMFDigitsDetected;
        }

        
        public boolean isDTMFDigitsDetectedPresent () {
            return this.dTMFDigitsDetected != null;
        }
        

        public void setDTMFDigitsDetected (DTMFDigitsDetected value) {
            this.dTMFDigitsDetected = value;
        }
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(TDTMFEnteredArg.class);
