...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "AnalyzeRouteArg", isSet = false )
    public class AnalyzeRouteArg implements IASN1PreparedElement {
...
@ASN1SequenceOf( name = "aMADigitsDialedWC", isSetOf = false ) 
	...
	private Prefix prefix = null;
        ...
        @ASN1Element ( name = "genericDigitsList", isOptional =  true , hasTag =  false  , hasDefaultValue =  false  )
    
	private GenericDigitsList genericDigitsList = null;
	...
	private GenericName genericName = null;
        ...
        public GenericDigitsList getGenericDigitsList () {
            return this.genericDigitsList;
        }

        
        public boolean isGenericDigitsListPresent () {
            return this.genericDigitsList != null;
        }
        

        public void setGenericDigitsList (GenericDigitsList value) {
            this.genericDigitsList = value;
        }
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(AnalyzeRouteArg.class);
