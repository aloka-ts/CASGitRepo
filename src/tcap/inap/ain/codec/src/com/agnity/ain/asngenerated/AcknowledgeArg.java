...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "AcknowledgeArg", isSet = false )
    public class AcknowledgeArg implements IASN1PreparedElement {
	...
	private ExtensionParameter extensionParameter = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(AcknowledgeArg.class);
