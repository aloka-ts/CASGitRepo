...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "OSuspendedArg", isSet = false )
    public class OSuspendedArg implements IASN1PreparedElement {
	...
	private PointInCall pointInCall = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(OSuspendedArg.class);
