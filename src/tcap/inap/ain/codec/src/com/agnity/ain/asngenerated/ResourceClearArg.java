...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "ResourceClearArg", isSet = false )
    public class ResourceClearArg implements IASN1PreparedElement {
	...
	private ExtensionParameter extensionParameter = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(ResourceClearArg.class);
