...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "NCARequestArg", isSet = false )
    public class NCARequestArg implements IASN1PreparedElement {
	...
	private ControlEncountered controlEncountered = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(NCARequestArg.class);
