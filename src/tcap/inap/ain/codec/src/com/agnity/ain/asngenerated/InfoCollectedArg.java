...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "InfoCollectedArg", isSet = false )
    public class InfoCollectedArg implements IASN1PreparedElement {
	...
	private CalledPartyID calledPartyID = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(InfoCollectedArg.class);
