...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "InfoAnalyzedArg", isSet = false )
    public class InfoAnalyzedArg implements IASN1PreparedElement {
	...
	private CTRConnection cTRConnection = null;
        ...
        @ASN1Element ( name = "jurisdictionInformation", isOptional =  true , hasTag =  false  , hasDefaultValue =  false  )
    
	private JurisdictionInformation jurisdictionInformation = null;
	...
	private TriggerInformation triggerInformation = null;
        ...
        public JurisdictionInformation getJurisdictionInformation () {
            return this.jurisdictionInformation;
        }

        
        public boolean isJurisdictionInformationPresent () {
            return this.jurisdictionInformation != null;
        }
        

        public void setJurisdictionInformation (JurisdictionInformation value) {
            this.jurisdictionInformation = value;
        }
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(InfoAnalyzedArg.class);
