...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "ContinueArg", isSet = false )
    public class ContinueArg implements IASN1PreparedElement {
...
@ASN1SequenceOf( name = "aMADigitsDialedWC", isSetOf = false ) 
	...
	private AMAServiceProviderID aMAServiceProviderID = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(ContinueArg.class);
