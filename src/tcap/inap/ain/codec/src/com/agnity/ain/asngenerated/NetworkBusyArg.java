...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "NetworkBusyArg", isSet = false )
    public class NetworkBusyArg implements IASN1PreparedElement {
	...
	private TriggerInformation triggerInformation = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(NetworkBusyArg.class);
