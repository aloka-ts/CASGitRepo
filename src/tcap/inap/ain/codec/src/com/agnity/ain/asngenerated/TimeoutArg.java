...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "TimeoutArg", isSet = false )
    public class TimeoutArg implements IASN1PreparedElement {
	...
	private NotificationIndicator notificationIndicator = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(TimeoutArg.class);
