...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "OMidCallArg", isSet = false )
    public class OMidCallArg implements IASN1PreparedElement {
	...
	private ExtensionParameter extensionParameter = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(OMidCallArg.class);
