...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "MonitorSuccessArg", isSet = false )
    public class MonitorSuccessArg implements IASN1PreparedElement {
	...
	private ExtensionParameter extensionParameter = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(MonitorSuccessArg.class);
