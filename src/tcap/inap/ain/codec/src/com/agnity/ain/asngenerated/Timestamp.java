...
import org.bn.types.*;
    ...
    public class Timestamp implements IASN1PreparedElement {
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(Timestamp.class);
