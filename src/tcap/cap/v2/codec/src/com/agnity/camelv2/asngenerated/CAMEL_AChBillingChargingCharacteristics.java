...
import org.bn.types.*;
   ...
   @ASN1OctetString( name = "" )
        ...
        @ASN1Element ( name = "releaseIfdurationExceeded", isOptional =  true , hasTag =  true, tag = 1 , hasDefaultValue =  false  )

        private byte[] releaseIfdurationExceeded = null;
  ...
  @ASN1Boolean( name = "" )
	...
	private Boolean tone = null;
       ...
       public byte[] getReleaseIfdurationExceeded () {
            return this.releaseIfdurationExceeded;
        }
        

        public void setReleaseIfdurationExceeded (byte[] value) {
