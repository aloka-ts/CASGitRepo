...
import com.agnity.cap.v2.datatypes.enumType.TypeOfShapeCapV2Enum;
 ...
 */
public class GeographicalInformationCapV2 {
	
  private TypeOfShapeCapV2Enum typeOfShape;
  private byte[] degreesOfLatitude;
  private byte[] degreesOfLongitude;
  private byte[] uncertaintyCode;
  private static Logger logger = Logger.getLogger(GeographicalInformationCapV2.class);
  
   /**
    * @return TypeOfShapeCapV2Enum object
    */
	public TypeOfShapeCapV2Enum getTypeOfShape() {
		return typeOfShape;
	}
	 ...
	 * @param typeOfShape
	 */
	public void setTypeOfShape(TypeOfShapeCapV2Enum typeOfShape) {
	 ...
	 */
	public static GeographicalInformationCapV2 decode(byte[] bytes) throws InvalidInputException{
	    if(logger.isDebugEnabled()){
	    	logger.debug("in decode. GeographicalInformation byte array length::"+bytes.length);
	    }
		GeographicalInformationCapV2 gi = new GeographicalInformationCapV2();
		gi.typeOfShape = TypeOfShapeCapV2Enum.getValue((bytes[0]>>4)& 0x0f);
	 ...
	 * @throws InvalidInputException
	 */
	public static byte[] encode(GeographicalInformationCapV2 gi) throws InvalidInputException{
		byte[] bytes = null;
