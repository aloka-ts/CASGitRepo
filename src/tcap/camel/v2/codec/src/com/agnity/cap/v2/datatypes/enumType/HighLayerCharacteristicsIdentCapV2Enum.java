...
public enum HighLayerCharacteristicsIdentCapV2Enum {
	...
	private HighLayerCharacteristicsIdentCapV2Enum(int code){
		this.code = code;
	}
	...
	public static  HighLayerCharacteristicsIdentCapV2Enum getValue(int tag){
		switch (tag) {
