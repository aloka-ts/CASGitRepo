 ...
 */
public class CellGlobalIdOrServiceAreaIdFixedLengthCapV2{
	...
	private static Logger logger = Logger.getLogger(CellGlobalIdOrServiceAreaIdFixedLengthCapV2.class);
	 ...
	 */
	public static CellGlobalIdOrServiceAreaIdFixedLengthCapV2 decode(byte[] bytes) throws InvalidInputException{
		if(logger.isDebugEnabled()){
			logger.debug("In decode, CellGlobalIdOrServiceAreaIdFixedLength bytes array length::"+bytes.length);
		}
		
		CellGlobalIdOrServiceAreaIdFixedLengthCapV2 ci = new CellGlobalIdOrServiceAreaIdFixedLengthCapV2();
	 ...
	 * CellGlobalIdOrServiceAreaIdFixedLength
	 */
	public static byte[] encode(CellGlobalIdOrServiceAreaIdFixedLengthCapV2 ci) throws InvalidInputException{
		byte[] bytes= null;
