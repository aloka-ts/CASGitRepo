...
public enum PresentationMethodOfProtocolProfileCapV2Enum {
	...
	private PresentationMethodOfProtocolProfileCapV2Enum(int code){
		this.code = code;
	}
	...
	public static PresentationMethodOfProtocolProfileCapV2Enum getValue(int tag){
		switch (tag) {
