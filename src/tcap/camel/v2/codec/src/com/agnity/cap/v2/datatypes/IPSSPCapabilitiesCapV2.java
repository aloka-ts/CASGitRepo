 ...
 */
public class IPSSPCapabilitiesCapV2 {
    ...
    private static Logger logger = Logger.getLogger(IPSSPCapabilitiesCapV2.class);
	 ...
	 */
    public static IPSSPCapabilitiesCapV2 decode(byte[] bytes)  throws InvalidInputException{
    	
        IPSSPCapabilitiesCapV2 ips = null;
        if(bytes!=null){
            	ips = new IPSSPCapabilitiesCapV2();
     ...
     * @param IPSSPCapabilitiesCapV2 object with valid parameters
     * @return IPSSPCapabilities byte array
     */
    public static byte[] encode(IPSSPCapabilitiesCapV2 ips)  throws InvalidInputException{
    	byte[] bytes= null;
