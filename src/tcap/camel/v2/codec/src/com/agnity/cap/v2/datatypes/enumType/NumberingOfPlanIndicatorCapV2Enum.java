...
public enum NumberingOfPlanIndicatorCapV2Enum {
	/*
	    0 0 0 spare 
	...
	private int code;
	private NumberingOfPlanIndicatorCapV2Enum(int code){
		this.code = code;
	}
   ...
   public static NumberingOfPlanIndicatorCapV2Enum getValue(int tag){
		switch (tag) {
