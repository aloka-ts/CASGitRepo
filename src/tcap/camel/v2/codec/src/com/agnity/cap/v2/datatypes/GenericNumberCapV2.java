...
public class GenericNumberCapV2 {
	...
	public static GenericNumberCapV2 decode(byte[] bytes) throws InvalidInputException{
		GenericNumberCapV2 GNCapV2 = new GenericNumberCapV2();
	...
	public static byte[] encode(GenericNumberCapV2 GNCapV2) throws InvalidInputException
	{	
	...
	public static void main(String[] args) throws InvalidInputException {
		...
		GenericNumberCapV2 decode= new GenericNumberCapV2();
		GenericNumberCapV2 decodeAG= new GenericNumberCapV2();


		byte[] Values = new byte[]{(byte)0x06,(byte)0x04,(byte)0x13,(byte)0x79,(byte)0x52,(byte)0x97,(byte)0x30,(byte)0x96,(byte)0x20};

		decode=GenericNumberCapV2.decode(Values);
		...
		byte[] Values2 =GenericNumberCapV2.encode(decode);
		
		decodeAG=GenericNumberCapV2.decode(Values2);	
