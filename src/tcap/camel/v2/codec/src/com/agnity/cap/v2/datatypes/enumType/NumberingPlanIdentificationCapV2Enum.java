...
public enum NumberingPlanIdentificationCapV2Enum {
	...
	*/
	...
	private int code;
	private NumberingPlanIdentificationCapV2Enum(int code){
		this.code=code;
	}
	...
	public int getCode() {
	   ...
	   public static NumberingPlanIdentificationCapV2Enum getValue(int tag){
		   switch (tag) {
