...
public enum NatureOfAddressIndicatorCapV2Enum {
	...
	private int code;
	private NatureOfAddressIndicatorCapV2Enum(int i){
		this.code = i;
	}
	...
	public static NatureOfAddressIndicatorCapV2Enum getValue(int code){
		switch (code) {
		case 0: return SPARE; 
