...
import com.agnity.cap.v2.datatypes.GenericNumberCapV2;
import com.agnity.cap.v2.exceptions.InvalidInputException;

import junit.framework.TestCase;

public class GenericNumberCapV2Test extends TestCase {
	...
	public void testDecodeEncode() throws InvalidInputException {
	    ...
	    byte[] exValue = GenericNumberCapV2.encode(GenericNumberCapV2.decode(value));
