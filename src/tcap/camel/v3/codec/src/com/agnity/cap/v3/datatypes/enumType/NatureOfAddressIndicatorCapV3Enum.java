...
public enum NatureOfAddressIndicatorCapV3Enum {
	...
	private int code;
	private NatureOfAddressIndicatorCapV3Enum(int i){
		this.code = i;
	}
	...
	public static NatureOfAddressIndicatorCapV3Enum getValue(int code){
		switch (code) {
		case 0: return SPARE; 
