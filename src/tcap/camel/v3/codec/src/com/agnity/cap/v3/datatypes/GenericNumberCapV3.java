...
public class GenericNumberCapV3 {
	...
	public static GenericNumberCapV3 decode(byte[] bytes) throws InvalidInputException{
		GenericNumberCapV3 GNCapV2 = new GenericNumberCapV3();
	...
	public static byte[] encode(GenericNumberCapV3 GNCapV2) throws InvalidInputException
	{	
	...
	public static void main(String[] args) throws InvalidInputException {
		...
		GenericNumberCapV3 decode= new GenericNumberCapV3();
		GenericNumberCapV3 decodeAG= new GenericNumberCapV3();


		byte[] Values = new byte[]{(byte)0x06,(byte)0x04,(byte)0x13,(byte)0x79,(byte)0x52,(byte)0x97,(byte)0x30,(byte)0x96,(byte)0x20};

		decode=GenericNumberCapV3.decode(Values);
		...
		byte[] Values2 =GenericNumberCapV3.encode(decode);
		
		decodeAG=GenericNumberCapV3.decode(Values2);	
