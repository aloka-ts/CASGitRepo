...
public enum InformationTransferCapabilityCapV3Enum {
     /*
	 Bits
     54321
     00000 - Speech
	...
	private InformationTransferCapabilityCapV3Enum(int code){
		this.code = code;
	}
	...
	public static InformationTransferCapabilityCapV3Enum getValue(int tag){
		switch (tag) {
