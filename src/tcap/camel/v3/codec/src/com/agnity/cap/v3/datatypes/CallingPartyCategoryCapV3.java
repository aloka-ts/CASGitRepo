...
import com.agnity.cap.v3.datatypes.enumType.CallingPartyCategoryCapV2Enum;
 ...
 */
public class CallingPartyCategoryCapV3 {
 	
	private CallingPartyCategoryCapV2Enum callingPartyCategory;
	private static Logger logger = Logger.getLogger(CallingPartyCategoryCapV3.class);
	 ...
	 */
	public static CallingPartyCategoryCapV3 decode(byte[] bytes)  throws InvalidInputException {
		CallingPartyCategoryCapV3 cpc = null;
			cpc = new CallingPartyCategoryCapV3();
	...
	/**
	 * 
	 * @param CallingPartyCategoryCapV3 object with non-asn parameters
	 * @return encoded byte array for CallingPartyCategory
	 */
	public static byte[] encode(CallingPartyCategoryCapV3 cpc)  throws InvalidInputException{
		byte[] bytes= null;
