...
public enum UserInfoLayer1ProtocolCapV3Enum {
	...
	private UserInfoLayer1ProtocolCapV3Enum(int c) {
		code = c;
	}
	...
	public static UserInfoLayer1ProtocolCapV3Enum getValue(int num) {
		switch (num) {
