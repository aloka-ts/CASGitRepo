...
public enum UserInfoLayer3ProtocolCapV3Enum {
	...
	private UserInfoLayer3ProtocolCapV3Enum(int c) {
		code = c;
	}
	...
	public static UserInfoLayer3ProtocolCapV3Enum getValue(int num) {
		switch (num) {
