...
public enum InformationTransferRateCapV3Enum {
	...
	private InformationTransferRateCapV3Enum(int c) {
		code = c;
	}
	...
	public static InformationTransferRateCapV3Enum getValue(int num) {
		switch (num) {
