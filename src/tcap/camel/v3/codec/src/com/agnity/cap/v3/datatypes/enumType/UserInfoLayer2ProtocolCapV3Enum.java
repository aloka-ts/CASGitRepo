...
public enum UserInfoLayer2ProtocolCapV3Enum {
	...
	private UserInfoLayer2ProtocolCapV3Enum(int c) {
		code = c;
	}
	...
	public static UserInfoLayer2ProtocolCapV3Enum getValue(int num) {
		switch (num) {
