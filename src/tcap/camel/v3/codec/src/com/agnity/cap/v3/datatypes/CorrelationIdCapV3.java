...
public class CorrelationIdCapV3 {
	...
	public static CorrelationIdCapV3 decode(byte[] bytes) throws InvalidInputException {
		CorrelationIdCapV3 CRCAPV2 = new CorrelationIdCapV3();
		CRCAPV2.encodingSchema = EncodingSchemeCapV3Enum.getValue((byte) (bytes[0])&0x1f);
		CRCAPV2.typeOfDigits = TypeOfDigitsCapV3Enum.getValue((byte) (bytes[0]>>5)&0x07);
	...
	public static byte[] encode(CorrelationIdCapV3 CRCAPV2) throws InvalidInputException
	{	
	...
	public static void main(String[] args) throws InvalidInputException{
		...
		CorrelationIdCapV3 decode= new CorrelationIdCapV3();
		CorrelationIdCapV3 decodeAG= new CorrelationIdCapV3();


		byte[] Values = new byte[]{(byte)0x63,(byte)0x79,(byte)0x52,(byte)0x97,(byte)0x30,(byte)0x96,(byte)0x20};

		decode=CorrelationIdCapV3.decode(Values);
		...
		byte[] Values2 =CorrelationIdCapV3.encode(decode);
		
		decodeAG=CorrelationIdCapV3.decode(Values2);	
