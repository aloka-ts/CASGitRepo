 ...
 *
 */
public enum AdditionalLayer3ProtocolInfoCapV3Enum {
	/**
	...
	private AdditionalLayer3ProtocolInfoCapV3Enum(int c) {
		code = c;
	}
	...
	public static AdditionalLayer3ProtocolInfoCapV3Enum getValue(int num) {
		switch (num) {
