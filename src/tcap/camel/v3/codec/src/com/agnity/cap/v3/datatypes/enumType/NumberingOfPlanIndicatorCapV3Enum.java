...
public enum NumberingOfPlanIndicatorCapV3Enum {
	/*
	    0 0 0 spare 
	...
	NUMBERING_PLAN_RESERVED_5(5),NUMBERING_PLAN_RESERVED_6(6),
	SPARE_7(7);
	
	private int code;
	private NumberingOfPlanIndicatorCapV3Enum(int code){
		this.code = code;
	}
   ...
   public static NumberingOfPlanIndicatorCapV3Enum getValue(int tag){
		switch (tag) {
		...
		case 5: return NUMBERING_PLAN_RESERVED_5; 
		case 6: return NUMBERING_PLAN_RESERVED_6;
