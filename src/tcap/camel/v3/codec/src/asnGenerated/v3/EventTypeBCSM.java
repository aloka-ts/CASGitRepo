...
import org.bn.types.*;
    ...
    public class EventTypeBCSM implements IASN1PreparedElement {        
        public enum EnumType {
            ...
            collectedInfo , 
            @ASN1EnumItem ( name = "analyzedInformation", hasTag = true , tag = 3 )
            analyzedInformation , 
            ...
            callAccepted , 
            @ASN1EnumItem ( name = "oChangeOfPosition", hasTag = true , tag = 50 )
            oChangeOfPosition , 
            @ASN1EnumItem ( name = "tChangeOfPosition", hasTag = true , tag = 51 )
            tChangeOfPosition , 
            @ASN1EnumItem ( name = "oServiceChange", hasTag = true , tag = 52 )
            oServiceChange , 
            @ASN1EnumItem ( name = "tServiceChange", hasTag = true , tag = 53 )
            tServiceChange , 
        }
