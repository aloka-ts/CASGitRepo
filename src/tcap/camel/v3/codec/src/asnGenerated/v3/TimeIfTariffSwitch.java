...
import org.bn.types.*;
  ...
  @ASN1Integer( name = "" )
    @ASN1ValueRangeConstraint ( 
        ...
        @ASN1Element ( name = "tttariffSwitchInterval", isOptional =  true , hasTag =  true, tag = 1 , hasDefaultValue =  false  )
    
	private Integer tttariffSwitchInterval = null;
        ...
        public Integer getTttariffSwitchInterval () {
            return this.tttariffSwitchInterval;
        }

        
        public boolean isTttariffSwitchIntervalPresent () {
            return this.tttariffSwitchInterval != null;
        }
        

        public void setTttariffSwitchInterval (Integer value) {
            this.tttariffSwitchInterval = value;
        }
