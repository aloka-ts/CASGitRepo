...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "AOCGprs", isSet = false )
    public class AOCGprs implements IASN1PreparedElement {
	...
	private AOCSubsequent aOCSubsequent = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(AOCGprs.class);
