...
import org.bn.types.*;
    ...
    public class Extensions implements IASN1PreparedElement {
	    ...
	    private java.util.Collection<ExtensionField> value = null; 
            ...
            public Extensions ( java.util.Collection<ExtensionField> value ) {
                setValue(value);
            }
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(Extensions.class);
