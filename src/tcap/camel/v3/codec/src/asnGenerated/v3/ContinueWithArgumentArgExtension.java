...
import org.bn.types.*;
    ...
    public class ContinueWithArgumentArgExtension implements IASN1PreparedElement {
        ...
        @ASN1Null ( name = "suppress-D-CSI" ) 
    
        @ASN1Element ( name = "suppress-D-CSI", isOptional =  true , hasTag =  true, tag = 0 , hasDefaultValue =  false  )
    
	private org.bn.types.NullObject suppress_D_CSI = null;
                
  
        @ASN1Null ( name = "suppress-N-CSI" ) 
    
        @ASN1Element ( name = "suppress-N-CSI", isOptional =  true , hasTag =  true, tag = 1 , hasDefaultValue =  false  )
    
	private org.bn.types.NullObject suppress_N_CSI = null;
                
  
        @ASN1Null ( name = "suppressOutgoingCallBarring" ) 
    
        @ASN1Element ( name = "suppressOutgoingCallBarring", isOptional =  true , hasTag =  true, tag = 2 , hasDefaultValue =  false  )
    
	private org.bn.types.NullObject suppressOutgoingCallBarring = null;
