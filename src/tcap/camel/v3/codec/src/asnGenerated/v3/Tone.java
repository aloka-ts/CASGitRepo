...
import org.bn.types.*;
	...
	private Integer4 toneID = null;
        ...
        @ASN1Element ( name = "duration3", isOptional =  true , hasTag =  true, tag = 1 , hasDefaultValue =  false  )
    
	private Integer4 duration3 = null;
        ...
        public Integer4 getDuration3 () {
            return this.duration3;
        }

        
        public boolean isDuration3Present () {
            return this.duration3 != null;
        }
        

        public void setDuration3 (Integer4 value) {
