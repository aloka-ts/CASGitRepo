...
/**
 *
 * The DeleteProviderException is thrown when a problem is
 * encountered while trying to delete an object that implements
 * the Jain Provider interface.
 *
...
public class DeleteProviderException extends JainException {
    ...
    /**
    * Constructs a new <code>DeleteProviderException</code> with the specified detail
    * message.
    *
