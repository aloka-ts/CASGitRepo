...
public class GlobalTitle implements java.io.Serializable {
    ...
    */
    ...
    /**
     * String representation of class Global Title
     *
     * @return    String provides description of class GlobalTitle
     */
	public String toString() {
		StringBuffer buffer = new StringBuffer(1000);
		buffer.append(" Address Information Present "
				+ addressInformationPresent + ", ");
		if (addressInformationPresent) {
			buffer.append("Address Information ");
			for (int i = 0; i < addressInformation.length; i++) {
				buffer.append("Address Information[" + i + "] "
						+ (addressInformation[i] & 0XFF) + ", ");
			}
		}
