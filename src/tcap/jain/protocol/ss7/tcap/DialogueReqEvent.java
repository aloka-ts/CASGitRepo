...
public abstract class DialogueReqEvent extends java.util.EventObject implements java.io.Serializable, java.lang.Cloneable {
    ...
    */
	...
	/* GB */
	public abstract SccpUserAddress getOriginatingAddress() throws MandatoryParameterNotSetException, ParameterNotSetException;
    ...
    */
	...
	private String sequenceControl;
	...
	public void setSequenceControl(String sequenceControl) {
