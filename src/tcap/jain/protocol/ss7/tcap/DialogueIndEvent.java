...
public abstract class DialogueIndEvent extends java.util.EventObject implements java.io.Serializable, java.lang.Cloneable {
    ...
    */
	 ...
	 *
	 */
	public abstract SccpUserAddress getDestinationAddress() throws MandatoryParameterNotSetException,  ParameterNotSetException;
    ...
    */
	...
	private SignalingPointCode mtp3Opc;

	
	public SignalingPointCode getMtp3Opc() {
		return mtp3Opc;
	}

	public void setMtp3Opc(SignalingPointCode mtp3Opc) {
		this.mtp3Opc = mtp3Opc;
	}
	...
	public void setMtp3Dpc(SignalingPointCode mtp3Dpc) {
	 ...
	 /**
	 *@serial    m_returnOption - a default serializable field
	 */
	private int m_returnOption = 0;

	private boolean m_returnOptionPresent = false;
	
	public int getM_returnOption() throws MandatoryParameterNotSetException{
		if (m_returnOptionPresent == true) {
			return m_returnOption;
		}
		else {
			throw new MandatoryParameterNotSetException();
		}
	...
	public void setM_returnOption(int m_returnOption) {
		this.m_returnOption = m_returnOption;
		m_returnOptionPresent = true;
	}


	public boolean isReturnOptionPresent() {
		return m_returnOptionPresent;
	}
	
	 /**
	 *@serial    m_sequenceControl - a default serializable field
	 */
	private int m_sequenceControl = 0;

	private boolean m_sequenceControlPresent = false;
	
	public int getM_sequenceControl() throws MandatoryParameterNotSetException{
		if (m_sequenceControlPresent == true) {
	...
	public void setM_sequenceControl(int m_sequenceControl) {
		this.m_sequenceControl = m_sequenceControl;
		m_sequenceControlPresent = true;
	}


	public boolean isSequenceControlPresent() {
		return m_sequenceControlPresent;
	}

	 /**
	 *@serial m_messagePriority - a default serializable field
	 */
	private int m_messagePriority = 0;

	private boolean m_messagePriorityPresent = false;
	
	public int getM_messagePriority() throws MandatoryParameterNotSetException{
		if (m_messagePriorityPresent == true) {
	...
	public void setM_messagePriority(int m_messagePriority) {
		this.m_messagePriority = m_messagePriority;
		m_messagePriorityPresent = true;
	}


	public boolean isMessagePriorityPresent() {
		return m_messagePriorityPresent;
	}
}
