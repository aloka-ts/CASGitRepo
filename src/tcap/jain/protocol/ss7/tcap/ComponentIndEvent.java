...
public abstract class ComponentIndEvent extends java.util.EventObject implements java.io.Serializable, java.lang.Cloneable {
    ...
    */
    public void setLastComponent(boolean lastComponent) {
        ...
        m_lastComponentPresent = true;
    }
	/* GB */
	public boolean isLastComponentPresent()
	{
		return m_lastComponentPresent;
	}
    ...
    * follows:-
    *  <UL>
    *    <LI> PRIMITIVE_INVOKE Component :- The Invoke Identifier is the Invoke Identifier
    *    as specified in both the ITU and ANSI recommendations for the Invoke
    *    component.
    *    <LI> PRIMITIVE_RESULT Component :- The Invoke Identifier is the Invoke Identifier
    ...
    *    <LI> PRIMITIVE_REJECT Component :- The Invoke Identifier is the Invoke Identifier
    *    as specified in the ITU recommendation and the Correlation Identifier as
    *    specified in the ANSI recommendation for the Reject component.
    *    <LI> PRIMITIVE_ERROR Component :- The Invoke Identifier is the Invoke Identifier as
