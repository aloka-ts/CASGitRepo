...
public interface JainTcapProvider extends java.util.EventListener {
    ...
    */
    public void addJainTcapListener(JainTcapListener listener, SccpUserAddress userAddress)
			            throws TooManyListenersException, ListenerAlreadyRegisteredException,
			            InvalidAddressException, /*GB*/ IOException;
    ...
    */
    public void removeJainTcapListener(JainTcapListener listener) throws ListenerNotRegisteredException, IOException;
    ...
    */
    public boolean isAttached();
     ...
     /**
     * Added following method for keeping map of Ansi Correlation id with dialogue id . for creating/getting
     * tcap session against correlation id in Provider instaed of Dialogue id .As multiple dialogue ids may exist in single 
     * call in Ansi e.g WIN but correlation id will be only one e.g billingid in WIN. 
     * @param correlationId
     * @param dialogueId
     */
