...
public final class BeginIndEvent extends DialogueIndEvent {
	...
	/* GB */
	public BeginIndEvent(Object source) {super(source);}
	/* GB */
	/**
	...
	public int getAppContextType() throws ParameterNotSetException{
		if (m_appContextTypePresent == true) {
			return m_appContextType;
		}
		else {
			throw new ParameterNotSetException();
		}
	...
	public void setAppContextType(int mAppContextType) {
		m_appContextType = mAppContextType;
		m_appContextTypePresent = true;
	}

	public boolean isAppContextTypePresent() {
		return m_appContextTypePresent;
	}
	...
	public void setAppContextName(byte[] mAppContextName) {
		m_appContextName = mAppContextName;
	...
	/**
	 *@serial    m_appContextType - a default serializable field
	 */

	private int m_appContextType = 0;
	

	/**
	 *@serial    m_appContextTypePresent - a default serializable field
	 */

	private boolean m_appContextTypePresent = false;
