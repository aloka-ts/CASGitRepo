...
public final class DialoguePortion implements java.io.Serializable {
	...
	/* GB */
	public DialoguePortion(Object source) {}
	/* GB */
	...
	public void setAppContextIdentifier(int appContextIdentifier) {
		...
		/* GB */
		m_appContextIdentifierPresent = true;
	}
	...
	public void setSecurityContextInformation(byte[] securityContextInformation) {
	 ...
	 */
	public boolean isSecurityContextInformationPresent() {
	...
	public byte[] getSecurityContextInformation() throws ParameterNotSetException {
	...
	public void clearAllParameters() {
		...
		/* GB */
		m_appContextIdentifierPresent = false;
	 ...
	 */
	/* GB */
	public boolean isAppContextIdentifierPresent() { return true; }
	...
	public boolean isSecurityContextIdentifierPresent() { return true; }
	/* GB */
	...
	/* GB */
	private boolean m_appContextIdentifierPresent = false;
