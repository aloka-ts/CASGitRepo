...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "SSInvocationNotificationRes", isSet = false )
    public class SSInvocationNotificationRes implements IASN1PreparedElement {
	...
	private ExtensionContainer extensionContainer = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(SSInvocationNotificationRes.class);
