...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "RequestedInfov1", isSet = false )
    public class RequestedInfov1 implements IASN1PreparedElement {
	...
	private RequestedNodes requestedNodes = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(RequestedInfov1.class);
