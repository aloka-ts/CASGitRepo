...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "AnyTimeSubscriptionInterrogationArg", isSet = false )
    public class AnyTimeSubscriptionInterrogationArg implements IASN1PreparedElement {
	...
	private SubscriberIdentity subscriberIdentity = null;
        ...
        @ASN1Element ( name = "requestedSubscriptionInfo", isOptional =  false , hasTag =  true, tag = 1 , hasDefaultValue =  false  )
    
	private RequestedSubscriptionInfo requestedSubscriptionInfo = null;
	...
	private ISDN_AddressString gsmSCF_Address = null;
        ...
        public void setRequestedSubscriptionInfo (RequestedSubscriptionInfo value) {
            this.requestedSubscriptionInfo = value;
        }
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(AnyTimeSubscriptionInterrogationArg.class);
