...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "O_BcsmCamelTDPData", isSet = false )
    public class O_BcsmCamelTDPData implements IASN1PreparedElement {
	...
	private ExtensionContainer extensionContainer = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(O_BcsmCamelTDPData.class);
