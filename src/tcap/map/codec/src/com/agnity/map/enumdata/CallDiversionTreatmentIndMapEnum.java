 ...
 */
public enum CallDiversionTreatmentIndMapEnum {

	 CALL_DIVERSION_ALLOWED(1), CALL_DIVERSION_NOT_ALLOWED(2);
		
		private int code;
		
		private CallDiversionTreatmentIndMapEnum(int c){
			this.code=c;
		}
		...
		public static CallDiversionTreatmentIndMapEnum getValue(int tag){
			switch (tag) {
