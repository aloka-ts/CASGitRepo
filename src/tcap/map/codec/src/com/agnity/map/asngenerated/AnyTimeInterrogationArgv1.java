...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "AnyTimeInterrogationArgv1", isSet = false )
    public class AnyTimeInterrogationArgv1 implements IASN1PreparedElement {
	...
	private RequestedInfov1 requestedInfo = null;
	...
	private ExtensionContainer extensionContainer = null;
        ...
        public RequestedInfov1 getRequestedInfo () {
            return this.requestedInfo;
        }

        

        public void setRequestedInfo (RequestedInfov1 value) {
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(AnyTimeInterrogationArgv1.class);
