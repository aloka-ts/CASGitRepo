...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "UnexpectedDataParam", isSet = false )
    public class UnexpectedDataParam implements IASN1PreparedElement {
	...
	private ExtensionContainer extensionContainer = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(UnexpectedDataParam.class);
