...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "AnyTimeInterrogationRes", isSet = false )
    public class AnyTimeInterrogationRes implements IASN1PreparedElement {
            
        @ASN1Element ( name = "subscriberInfo", isOptional =  false , hasTag =  false  , hasDefaultValue =  false  )
	...
	private ExtensionContainer extensionContainer = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(AnyTimeInterrogationRes.class);
