...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "DataMissingParam", isSet = false )
    public class DataMissingParam implements IASN1PreparedElement {
	...
	private ExtensionContainer extensionContainer = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(DataMissingParam.class);
