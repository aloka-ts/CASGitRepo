...
import org.bn.types.*;
	...
	private ExtensionContainer extensionContainer = null;
        ...
        @ASN1Element ( name = "sai-Present", isOptional =  true , hasTag =  true, tag = 6 , hasDefaultValue =  false  )
	...
	private org.bn.types.NullObject currentLocationRetrieved = null;
        ...
        @ASN1Element ( name = "ageOfLocationInformation", isOptional =  true , hasTag =  true, tag = 9 , hasDefaultValue =  false  )
    
	private AgeOfLocationInformation ageOfLocationInformation = null;
                
  
        @ASN1Element ( name = "userCSGInformation", isOptional =  true , hasTag =  true, tag = 10 , hasDefaultValue =  false  )
