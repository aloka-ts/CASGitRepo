...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "ATI_NotAllowedParam", isSet = false )
    public class ATI_NotAllowedParam implements IASN1PreparedElement {
	...
	private ExtensionContainer extensionContainer = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(ATI_NotAllowedParam.class);
