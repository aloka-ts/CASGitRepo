...
print "#                                                           #\n";
print "#                     AGNITY INC.                           #\n";
print "#        WELCOME TO THE NON EMS INSTALLER FOR CAS           #\n";
print "#                    ON $osname                             #\n";
print "#                                                           #\n";
print "#-----------------------------------------------------------#\n";
print " Please answer some questions about your installation, this will\n";
print " take about 10 minutes. All the questions are mandatory, some \n";
print " questions have some default answers.\n\n\n";
...
print LOG"Checking for is there is any previously installed version........\n";
@subfiles = grep (/^ASESubsystem/,readdir(DIR));

if(@subfiles > 0){

print LOG"YOU ALREADY HAVE ONE VERSION INSTALLED ON YOUR SYSTEM.....\n";

print"YOU ALREADY HAVE ONE INSTALLER INSTALLED ON YOUR SYSTEM.....\n";
...
if ($_ =~ /y/)
{
print LOG"INSTALLING NEW VESION ON YOUR SYSTEM..\n";
}
else
{
print LOG" QUITING FROM INSTALLATION.......THANKYOU!!\n";
}
}
...
{ 
  ...
  elsif ((/^MACROS/) || ($parsing==1))
  {
	...
	##########this will be used if user enters install root ......
...
print "\n Please change directory to INSTALLROOT/scripts and run \n";
print "the script ase_no_ems. This will start CAS in non-ems mode\n";
print "\nSteps to run \n";
print "\t<1> cd ASESubsystem/scripts\n";
if($osname =~ /MSWin/)
{
	print "\t<2> ase_no_ems.bat\n\n\n";
}
else
{ 
	print "\t<2> ./ase_no_ems &\n\n\n";
